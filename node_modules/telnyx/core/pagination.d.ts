...
export declare namespace CursorFlatPaginationResponse {
    interface Meta {
        cursor?: string;
        has_more?: boolean;
    }
...
export declare class CursorFlatPagination<Item> extends AbstractPage<Item> implements CursorFlatPaginationResponse<Item> {
    data: Array<Item>;
    meta: CursorFlatPaginationResponse.Meta;
    constructor(client: Telnyx, response: Response, body: CursorFlatPaginationResponse<Item>, options: FinalRequestOptions);
    getPaginatedItems(): Item[];
    nextPageRequestOptions(): PageRequestOptions | null;
}
...
export declare namespace EmailCursorPaginationResponse {
    interface Meta {
        page_cursor?: string;
    }
}
...
export declare class EmailCursorPagination<Item> extends AbstractPage<Item> implements EmailCursorPaginationResponse<Item> {
    data: Array<Item>;
    meta: EmailCursorPaginationResponse.Meta;
    constructor(client: Telnyx, response: Response, body: EmailCursorPaginationResponse<Item>, options: FinalRequestOptions);
    getPaginatedItems(): Item[];
    nextPageRequestOptions(): PageRequestOptions | null;
}
...
export declare namespace EmailBracketCursorPaginationResponse {
    interface Meta {
        page_cursor?: string;
    }
}
...
export declare class EmailBracketCursorPagination<Item> extends AbstractPage<Item> implements EmailBracketCursorPaginationResponse<Item> {
    data: Array<Item>;
    meta: EmailBracketCursorPaginationResponse.Meta;
    constructor(client: Telnyx, response: Response, body: EmailBracketCursorPaginationResponse<Item>, options: FinalRequestOptions);
    getPaginatedItems(): Item[];
    nextPageRequestOptions(): PageRequestOptions | null;
}
...
export declare namespace CloudfsCursorPaginationResponse {
    interface Meta {
...
export declare class CloudfsCursorPagination<Item> extends AbstractPage<Item> implements CloudfsCursorPaginationResponse<Item> {
    data: Array<Item>;
    meta: CloudfsCursorPaginationResponse.Meta;
    constructor(client: Telnyx, response: Response, body: CloudfsCursorPaginationResponse<Item>, options: FinalRequestOptions);
    getPaginatedItems(): Item[];
    nextPageRequestOptions(): PageRequestOptions | null;
}
