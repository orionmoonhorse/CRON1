...
export declare class Calls extends APIResource {
     ...
     * ```
     */
    list(queueName: string, query?: CallListParams | null | undefined, options?: RequestOptions): PagePromise<QueueCallsDefaultFlatPagination, QueueCall>;
    /**
...
export declare namespace Calls {
    export { type QueueCall as QueueCall, type CallRetrieveResponse as CallRetrieveResponse, type QueueCallsDefaultFlatPagination as QueueCallsDefaultFlatPagination, type CallListParams as CallListParams, type CallRetrieveParams as CallRetrieveParams, type CallRemoveParams as CallRemoveParams, type CallUpdateParams as CallUpdateParams, };
}
