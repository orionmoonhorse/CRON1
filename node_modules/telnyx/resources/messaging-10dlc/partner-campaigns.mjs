...
export class PartnerCampaigns extends APIResource {
    ...
    listSharedByMe(query = {}, options) {
        return this._client.getAPIList('/10dlc/partnerCampaign/sharedByMe', (PerPagePaginationV2), { query, ...options });
    }
    /**
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/10dlc/partner_campaigns', (PerPagePaginationV2), { query, ...options });
    }
    /**
...
//# sourceMappingURL=partner-campaigns.mjs.map