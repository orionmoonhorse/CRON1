...
class PhoneNumberAssignmentByProfile extends resource_1.APIResource {
    ...
    retrieveStatus(taskID, options) {
        return this._client.get((0, path_1.path) `/10dlc/phoneNumberAssignmentByProfile/${taskID}`, options);
    }
    /**
    ...
    retrievePhoneNumberStatus(taskID, query = {}, options) {
        return this._client.get((0, path_1.path) `/10dlc/phoneNumberAssignmentByProfile/${taskID}/phoneNumbers`, {
            query,
            ...options,
        });
    }
     ...
     * ```
     */
    listPhoneNumberStatus(taskID, query = {}, options) {
        return this._client.get((0, path_1.path) `/10dlc/phoneNumberAssignmentByProfile/${taskID}/phoneNumbers`, {
            query,
            ...options,
        });
