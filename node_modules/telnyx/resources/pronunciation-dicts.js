...
exports.PronunciationDicts = void 0;
 ...
 */
class PronunciationDicts extends resource_1.APIResource {
    /**
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/pronunciation_dicts', (pagination_1.DefaultFlatPagination), {
            query,
            ...options,
        });
    }
     ...
     */
    create(body, options) {
        return this._client.post('/pronunciation_dicts', (0, uploads_1.maybeMultipartFormRequestOptions)({ body, ...options }, this._client));
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/pronunciation_dicts/${id}`, {
            ...options,
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/pronunciation_dicts/${id}`, options);
    }
    /**
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/pronunciation_dicts/${id}`, { body, ...options });
    }
}
exports.PronunciationDicts = PronunciationDicts;
//# sourceMappingURL=pronunciation-dicts.js.map