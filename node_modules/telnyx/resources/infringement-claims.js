...
exports.InfringementClaims = void 0;
 ...
 */
class InfringementClaims extends resource_1.APIResource {
    /**
     ...
     * ```
     */
    retrieve(claimID, options) {
        return this._client.get((0, path_1.path) `/infringement_claims/${claimID}`, options);
    }
    /**
     ...
     * ```
     */
    contest(claimID, body, options) {
        return this._client.post((0, path_1.path) `/infringement_claims/${claimID}/contest`, { body, ...options });
    }
}
exports.InfringementClaims = InfringementClaims;
//# sourceMappingURL=infringement-claims.js.map