...
import * as LoaAPI from "./loa.mjs";
import { AgentInput, Loa, LoaRenderParams, LoaUpdateParams } from "./loa.mjs";
import * as NumbersAPI from "./numbers.mjs";
import { NumberAssociateParams, NumberDisassociateParams, NumberListParams, NumberRefreshParams, NumberRefreshResponse, NumberRetrieveParams, Numbers, ReputationPhoneNumber, ReputationPhoneNumberList, ReputationPhoneNumberListWithReputation, ReputationPhoneNumberWithReputation, ReputationPhoneNumbersDefaultFlatPagination } from "./numbers.mjs";
import * as RemediationAPI from "./remediation.mjs";
import { Remediation, RemediationCreateParams, RemediationListParams, RemediationListResponse, RemediationListResponsesDefaultFlatPagination, RemediationPerNumberResults, RemediationRequest, RemediationRequestWrapped, RemediationRetrieveParams, RemediationStatus } from "./remediation.mjs";
...
export declare class Reputation extends APIResource {
    ...
    loa: LoaAPI.Loa;
    remediation: RemediationAPI.Remediation;
    /**
     ...
     * ```
     */
    enable(enterpriseID: string, body: ReputationEnableParams, options?: RequestOptions): APIPromise<EnterpriseReputationPublicWrapped>;
    /**
     ...
     * ```
     */
    updateFrequency(enterpriseID: string, body: ReputationUpdateFrequencyParams, options?: RequestOptions): APIPromise<EnterpriseReputationPublicWrapped>;
}
 ...
 * registered numbers.
 */
export type ReputationCheckFrequency = 'business_daily' | 'daily' | 'weekly' | 'biweekly' | 'monthly' | 'never';
...
export declare namespace Reputation {
    export { type EnterpriseReputationPublic as EnterpriseReputationPublic, type EnterpriseReputationPublicWrapped as EnterpriseReputationPublicWrapped, type ReputationCheckFrequency as ReputationCheckFrequency, type ReputationEnableParams as ReputationEnableParams, type ReputationUpdateFrequencyParams as ReputationUpdateFrequencyParams, };
    export { Numbers as Numbers, type ReputationPhoneNumber as ReputationPhoneNumber, type ReputationPhoneNumberList as ReputationPhoneNumberList, type ReputationPhoneNumberListWithReputation as ReputationPhoneNumberListWithReputation, type ReputationPhoneNumberWithReputation as ReputationPhoneNumberWithReputation, type NumberRefreshResponse as NumberRefreshResponse, type ReputationPhoneNumbersDefaultFlatPagination as ReputationPhoneNumbersDefaultFlatPagination, type NumberListParams as NumberListParams, type NumberAssociateParams as NumberAssociateParams, type NumberDisassociateParams as NumberDisassociateParams, type NumberRetrieveParams as NumberRetrieveParams, type NumberRefreshParams as NumberRefreshParams, };
    export { Loa as Loa, type AgentInput as AgentInput, type LoaUpdateParams as LoaUpdateParams, type LoaRenderParams as LoaRenderParams, };
    export { Remediation as Remediation, type RemediationPerNumberResults as RemediationPerNumberResults, type RemediationRequest as RemediationRequest, type RemediationRequestWrapped as RemediationRequestWrapped, type RemediationStatus as RemediationStatus, type RemediationListResponse as RemediationListResponse, type RemediationListResponsesDefaultFlatPagination as RemediationListResponsesDefaultFlatPagination, type RemediationListParams as RemediationListParams, type RemediationCreateParams as RemediationCreateParams, type RemediationRetrieveParams as RemediationRetrieveParams, };
}
