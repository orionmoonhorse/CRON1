...
import * as ReputationAPI from "./reputation.js";
import { APIPromise } from "../../../core/api-promise.js";
import { RequestOptions } from "../../../internal/request-options.js";
/**
 * Phone-number reputation monitoring (spam-score lookup and tracking).
 */
export declare class Loa extends APIResource {
    /**
     ...
     * ```
     */
    update(enterpriseID: string, body: LoaUpdateParams, options?: RequestOptions): APIPromise<ReputationAPI.EnterpriseReputationPublicWrapped>;
    /**
     ...
     * ```
     */
    render(enterpriseID: string, body?: LoaRenderParams | null | undefined, options?: RequestOptions): APIPromise<Response>;
}
/**
...
export declare namespace LoaRenderParams {
    /**
     * Optional signature embedded in the rendered PDF. When omitted the PDF is
     * returned unsigned for the customer to sign and upload.
     */
...
export declare namespace Loa {
    export { type AgentInput as AgentInput, type LoaUpdateParams as LoaUpdateParams, type LoaRenderParams as LoaRenderParams, };
}
//# sourceMappingURL=loa.d.ts.map