...
import * as EnterprisesAPI from "../enterprises.mjs";
...
export declare class Numbers extends APIResource {
     ...
     * ```
     */
    list(enterpriseID: string, query?: NumberListParams | null | undefined, options?: RequestOptions): PagePromise<ReputationPhoneNumbersDefaultFlatPagination, ReputationPhoneNumber>;
    /**
     ...
     * ```
     */
    associate(enterpriseID: string, body: NumberAssociateParams, options?: RequestOptions): APIPromise<ReputationPhoneNumberList>;
    /**
     ...
     * ```
     */
    retrieve(phoneNumber: string, params: NumberRetrieveParams, options?: RequestOptions): APIPromise<ReputationPhoneNumberWithReputation>;
    /**
     ...
     * ```
     */
    refresh(enterpriseID: string, body: NumberRefreshParams, options?: RequestOptions): APIPromise<NumberRefreshResponse>;
}
...
export declare namespace NumberRefreshResponse {
    interface Data {
        /**
