...
class Numbers extends resource_1.APIResource {
    ...
    retrieve(phoneNumber, params, options) {
        ...
        return this._client.get((0, path_1.path) `/enterprises/${enterprise_id}/reputation/numbers/${phoneNumber}`, {
            query,
            ...options,
        });
    }
     ...
     * ```
     */
    refresh(enterpriseID, body, options) {
        return this._client.post((0, path_1.path) `/enterprises/${enterpriseID}/reputation/numbers/refresh`, {
            body,
            ...options,
        });
    }
