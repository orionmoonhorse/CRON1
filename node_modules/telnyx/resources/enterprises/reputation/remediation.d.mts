 ...
 */
export declare class Remediation extends APIResource {
    /**
     ...
     * ```
     */
    list(enterpriseID: string, query?: RemediationListParams | null | undefined, options?: RequestOptions): PagePromise<RemediationListResponsesDefaultFlatPagination, RemediationListResponse>;
    /**
     ...
     * ```
     */
    create(enterpriseID: string, body: RemediationCreateParams, options?: RequestOptions): APIPromise<RemediationRequestWrapped>;
    /**
     ...
     * ```
     */
    retrieve(remediationID: string, params: RemediationRetrieveParams, options?: RequestOptions): APIPromise<RemediationRequestWrapped>;
}
