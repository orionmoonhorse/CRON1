...
import { DirsDefaultFlatPagination } from "../dir/dir.mjs";
 ...
 */
export declare class Dir extends APIResource {
    /**
     ...
     * ```
     */
    list(enterpriseID: string, query?: DirListParams | null | undefined, options?: RequestOptions): PagePromise<DirsDefaultFlatPagination, DirAPI.Dir>;
    /**
     ...
     * ```
     */
    create(enterpriseID: string, body: DirCreateParams, options?: RequestOptions): APIPromise<DirAPI.DirWrapped>;
}
export interface DirListParams extends DefaultFlatPaginationParams {
     ...
     * Default `-created_at`.
     */
    sort?: 'created_at' | '-created_at' | 'updated_at' | '-updated_at' | 'display_name' | '-display_name' | 'status' | '-status' | 'submitted_at' | '-submitted_at' | 'verified_at' | '-verified_at' | 'expiring_at' | '-expiring_at';
}
