...
import { Dir, DirCreateParams, DirListParams } from "./dir.mjs";
import * as ReputationAPI from "./reputation/reputation.mjs";
import { EnterpriseReputationPublic, EnterpriseReputationPublicWrapped, Reputation, ReputationCheckFrequency, ReputationEnableParams, ReputationUpdateFrequencyParams } from "./reputation/reputation.mjs";
...
export declare class Enterprises extends APIResource {
     ...
     * ```
     */
    update(enterpriseID: string, body: EnterpriseUpdateParams, options?: RequestOptions): APIPromise<EnterprisePublicWrapped>;
    /**
