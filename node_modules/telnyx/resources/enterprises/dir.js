 ...
 */
class Dir extends resource_1.APIResource {
    /**
    ...
    list(enterpriseID, query = {}, options) {
        return this._client.getAPIList((0, path_1.path) `/enterprises/${enterpriseID}/dir`, (pagination_1.DefaultFlatPagination), { query, ...options });
    }
    /**
    ...
    create(enterpriseID, body, options) {
        return this._client.post((0, path_1.path) `/enterprises/${enterpriseID}/dir`, { body, ...options });
    }
}
exports.Dir = Dir;
