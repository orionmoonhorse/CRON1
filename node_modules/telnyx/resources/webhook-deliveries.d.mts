...
export declare class WebhookDeliveries extends APIResource {
     ...
     */
    list(query?: WebhookDeliveryListParams | null | undefined, options?: RequestOptions): PagePromise<WebhookDeliveriesDefaultFlatPagination, WebhookDelivery>;
    /**
...
export declare namespace WebhookDeliveries {
    export { type Attempt as Attempt, type HTTP as HTTP, type WebhookDelivery as WebhookDelivery, type WebhookDeliveryRetrieveResponse as WebhookDeliveryRetrieveResponse, type WebhookDeliveriesDefaultFlatPagination as WebhookDeliveriesDefaultFlatPagination, type WebhookDeliveryListParams as WebhookDeliveryListParams, };
}
