 ...
 */
export declare class EmailEvents extends APIResource {
    /**
     * Lists account-level email events sorted oldest first by
     * `occurred_at asc, id asc`.
     */
    list(query?: EmailEventListParams | null | undefined, options?: RequestOptions): PagePromise<EmailEventListResponsesEmailCursorPagination, EmailEventListResponse>;
    /**
     * Returns counts and rates for email events over a time range. The default start
     * time is 30 days ago.
     */
    retrieveStats(query?: EmailEventRetrieveStatsParams | null | undefined, options?: RequestOptions): APIPromise<EmailEventRetrieveStatsResponse>;
}
export type EmailEventListResponsesEmailCursorPagination = EmailCursorPagination<EmailEventListResponse>;
export type EmailEventType = 'queued' | 'deferred' | 'scheduled' | 'cancelled' | 'sandbox' | 'sending' | 'sent' | 'failed' | 'delivered' | 'bounced' | 'complained' | 'rejected' | 'opened' | 'clicked' | 'unsubscribed' | 'daily_limit_exceeded';
...
export declare namespace EmailEventListResponse {
    /**
     * Summary of the associated email message. Present when the email_message preload
     * is available.
     */
...
export declare namespace EmailEventRetrieveStatsResponse {
    interface Data {
        /**
