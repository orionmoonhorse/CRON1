 ...
 */
export declare class FqdnAuthenticationResource extends APIResource {
    /**
     ...
     * ```
     */
    patchAll(fqdnConnectionID: string, body?: FqdnAuthenticationPatchAllParams | null | undefined, options?: RequestOptions): APIPromise<FqdnAuthenticationPatchAllResponse>;
}
...
export declare namespace FqdnAuthenticationResource {
    export { type FqdnAuthentication as FqdnAuthentication, type FqdnAuthenticationListResponse as FqdnAuthenticationListResponse, type FqdnAuthenticationPatchAllResponse as FqdnAuthenticationPatchAllResponse, type FqdnAuthenticationPatchAllParams as FqdnAuthenticationPatchAllParams, };
}
//# sourceMappingURL=fqdn-authentication.d.mts.map