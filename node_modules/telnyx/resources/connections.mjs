...
export class Connections extends APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/connections', (DefaultFlatPagination), { query, ...options });
    }
    /**
    ...
    listActiveCalls(connectionID, query = {}, options) {
        return this._client.getAPIList(path `/connections/${connectionID}/active_calls`, (DefaultFlatPagination), { query, ...options });
    }
    /**
