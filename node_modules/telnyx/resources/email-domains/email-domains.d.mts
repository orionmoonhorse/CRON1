...
import * as EmailDomainsAPI from "./email-domains.mjs";
import * as WebhooksAPI from "./webhooks.mjs";
import { EmailWebhook, EmailWebhookEvent, EmailWebhookResponse, EmailWebhooksDefaultFlatPagination, OffsetPaginationMeta, WebhookCreateParams, WebhookDeleteParams, WebhookListParams, WebhookRetrieveParams, WebhookUpdateParams, Webhooks } from "./webhooks.mjs";
...
export declare class EmailDomains extends APIResource {
     ...
     * ```
     */
    list(query?: EmailDomainListParams | null | undefined, options?: RequestOptions): PagePromise<EmailDomainsDefaultFlatPagination, EmailDomain>;
    /**
     ...
     * ```
     */
    retrieveDNSRecords(domainID: string, options?: RequestOptions): APIPromise<EmailDomainRetrieveDNSRecordsResponse>;
    /**
     ...
     * ```
     */
    delete(id: string, params?: EmailDomainDeleteParams | null | undefined, options?: RequestOptions): APIPromise<EmailDomainResponse>;
    /**
     * Shared (`type: shared`) Telnyx-managed domains are included/readable for every
     * account, in addition to the account's own custom domains.
     *
     ...
     * ```
     */
    update(id: string, body: EmailDomainUpdateParams, options?: RequestOptions): APIPromise<EmailDomainResponse>;
    /**
...
export declare namespace EmailDomainRetrieveHealthResponse {
    interface Data {
        /**
