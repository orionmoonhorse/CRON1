...
export declare class Webhooks extends APIResource {
     ...
     * ```
     */
    list(domainID: string, query?: WebhookListParams | null | undefined, options?: RequestOptions): PagePromise<EmailWebhooksDefaultFlatPagination, EmailWebhook>;
    /**
     ...
     * ```
     */
    create(domainID: string, body: WebhookCreateParams, options?: RequestOptions): APIPromise<EmailWebhookResponse>;
    /**
     ...
     * ```
     */
    delete(id: string, params: WebhookDeleteParams, options?: RequestOptions): APIPromise<EmailWebhookResponse>;
    /**
     ...
     * ```
     */
    retrieve(id: string, params: WebhookRetrieveParams, options?: RequestOptions): APIPromise<EmailWebhookResponse>;
    /**
     ...
     * ```
     */
    update(id: string, params: WebhookUpdateParams, options?: RequestOptions): APIPromise<EmailWebhookResponse>;
}
 ...
 */
export type EmailWebhookEvent = 'email.scheduled' | 'email.sandbox' | 'email.queued' | 'email.sending' | 'email.sent' | 'email.delivered' | 'email.deferred' | 'email.bounced' | 'email.failed' | 'email.complained' | 'email.opened' | 'email.clicked' | 'email.unsubscribed' | 'email.received' | 'email_domain.created' | 'email_domain.verified' | 'email_domain.degraded' | 'email_domain.suspended' | 'email_domain.deleted';
