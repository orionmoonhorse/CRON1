...
class Voice extends resource_1.APIResource {
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/legacy/reporting/batch_detail_records/voice/${id}`, options);
    }
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/legacy/reporting/batch_detail_records/voice/${id}`, options);
    }
}
exports.Voice = Voice;
