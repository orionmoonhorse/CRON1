...
import { PerPagePagination } from "../../../../core/pagination.mjs";
...
export class Messaging extends APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/legacy/reporting/usage_reports/messaging', (PerPagePagination), { query, ...options });
    }
    /**
