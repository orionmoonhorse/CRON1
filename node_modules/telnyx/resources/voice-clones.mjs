...
export class VoiceClones extends APIResource {
     ...
     * ```
     */
    createFromUpload(params, options) {
        const { voice_clone_upload_request } = params;
        return this._client.post('/voice_clones/from_upload', multipartFormRequestOptions({ body: voice_clone_upload_request, ...options }, this._client));
    }
    /**
