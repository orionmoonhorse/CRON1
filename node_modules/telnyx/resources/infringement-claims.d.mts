...
import * as DirAPI from "./dir/dir.mjs";
 ...
 */
export declare class InfringementClaims extends APIResource {
    /**
     ...
     * @example
     * ```ts
     * const infringementClaimWrapped =
     *   await client.infringementClaims.retrieve(
     *     'e379fbc8-cd83-4bef-a280-a0ac9d00dcf8',
     *   );
     * ```
     */
    retrieve(claimID: string, options?: RequestOptions): APIPromise<InfringementClaimWrapped>;
    /**
     ...
     * ```ts
     * const infringementClaimWrapped =
     *   await client.infringementClaims.contest(
     *     'e379fbc8-cd83-4bef-a280-a0ac9d00dcf8',
     *     {
     *       contest_notes:
     ...
     * ```
     */
    contest(claimID: string, body: InfringementClaimContestParams, options?: RequestOptions): APIPromise<InfringementClaimWrapped>;
}
export type InfringementClaimsDefaultFlatPagination = DefaultFlatPagination<InfringementClaim>;
export interface InfringementClaim {
     ...
     */
    contest_documents?: Array<DirAPI.Document>;
    /**
     ...
     */
    contest_history?: Array<InfringementClaim.ContestHistory>;
    created_at?: string;
    /**
     * Snapshot of the DIR the claim is filed against, embedded for convenience.
     */
    dir?: InfringementClaim.Dir;
    dir_id?: string;
...
export declare namespace InfringementClaim {
    /**
    ...
    interface Dir {
         ...
         */
        status?: DirAPI.DirStatus;
    }
}
export interface InfringementClaimWrapped {
...
export declare namespace InfringementClaims {
    export { type InfringementClaim as InfringementClaim, type InfringementClaimWrapped as InfringementClaimWrapped, type InfringementClaimContestParams as InfringementClaimContestParams, };
}
//# sourceMappingURL=infringement-claims.d.mts.map