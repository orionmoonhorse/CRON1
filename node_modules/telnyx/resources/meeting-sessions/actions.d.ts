...
export declare class Actions extends APIResource {
     ...
     * ```
     */
    sendChat(id: string, body: ActionSendChatParams, options?: RequestOptions): APIPromise<ActionAcceptedResponse>;
    /**
...
export declare namespace ActionAcceptedResponse {
    interface Data {
        accepted: boolean;
    }
}
...
export declare namespace Actions {
    export { type ActionAcceptedResponse as ActionAcceptedResponse, type ActionSendChatParams as ActionSendChatParams, type ActionSpeakParams as ActionSpeakParams, };
}
