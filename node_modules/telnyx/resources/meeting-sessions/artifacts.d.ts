...
export declare class Artifacts extends APIResource {
     ...
     * ```
     */
    create(id: string, body: ArtifactCreateParams, options?: RequestOptions): APIPromise<MeetingSessionArtifactResponse>;
    /**
     ...
     * ```
     */
    retrieve(artifactID: string, params: ArtifactRetrieveParams, options?: RequestOptions): APIPromise<MeetingSessionArtifactResponse>;
}
...
export declare namespace MeetingSessionArtifact {
    interface Content {
        text: string;
    }
...
export declare namespace Artifacts {
    export { type MeetingSessionArtifact as MeetingSessionArtifact, type MeetingSessionArtifactResponse as MeetingSessionArtifactResponse, type ArtifactListResponse as ArtifactListResponse, type ArtifactCreateParams as ArtifactCreateParams, type ArtifactRetrieveParams as ArtifactRetrieveParams, };
}
