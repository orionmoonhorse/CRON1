...
import { ActionAcceptedResponse, ActionSendChatParams, ActionSpeakParams, Actions } from "./actions.mjs";
import * as ArtifactsAPI from "./artifacts.mjs";
import { ArtifactCreateParams, ArtifactListResponse, ArtifactRetrieveParams, Artifacts, MeetingSessionArtifact, MeetingSessionArtifactResponse } from "./artifacts.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class MeetingSessions extends APIResource {
     ...
     * ```
     */
    list(query?: MeetingSessionListParams | null | undefined, options?: RequestOptions): APIPromise<MeetingSessionListResponse>;
    /**
     ...
     * ```
     */
    update(id: string, body: MeetingSessionUpdateParams, options?: RequestOptions): APIPromise<MeetingSessionResponse>;
    /**
     ...
     * ```
     */
    retrieveEvents(id: string, query?: MeetingSessionRetrieveEventsParams | null | undefined, options?: RequestOptions): APIPromise<MeetingSessionRetrieveEventsResponse>;
    /**
     ...
     * ```
     */
    deleteRecordingMedia(id: string, options?: RequestOptions): APIPromise<MeetingSessionDeleteRecordingMediaResponse>;
    /**
     ...
     * ```
     */
    retrieveRecordings(id: string, options?: RequestOptions): APIPromise<MeetingSessionRetrieveRecordingsResponse>;
    /**
     ...
     * ```
     */
    retrieveTranscript(id: string, query?: MeetingSessionRetrieveTranscriptParams | null | undefined, options?: RequestOptions): APIPromise<MeetingSessionRetrieveTranscriptResponse>;
}
/**
...
export declare namespace MeetingSession {
    /**
     * Assistant configuration if an assistant is attached, otherwise null.
     */
    interface Assistant {
...
export declare namespace MeetingSessionDeleteRecordingMediaResponse {
    interface Data {
...
export declare namespace MeetingSessionRetrieveEventsResponse {
    interface Data {
        occurred_at: string;
        payload: {
            [key: string]: unknown;
...
export declare namespace MeetingSessionRetrieveRecordingsResponse {
    interface Data {
        /**
...
export declare namespace MeetingSessionRetrieveTranscriptResponse {
    interface Data {
...
export interface MeetingSessionCreateParams {
     ...
     */
    camera_image?: MeetingSessionCreateParams.MeetingSessionCameraImageBase64Source | MeetingSessionCreateParams.MeetingSessionCameraImageURLSource;
    /**
...
export declare namespace MeetingSessionCreateParams {
    /**
     * Request options for attaching a voice assistant to the session. Routing fields
     * (`call_control_connection_id`, `from`, and `loopback_sip_uri`) are used only to
     * establish the assistant call leg and are omitted from response objects.
    ...
    interface MeetingSessionCameraImageBase64Source {
        /**
    ...
    interface MeetingSessionCameraImageURLSource {
        /**
         * Only JPEG images are accepted.
         */
        format: 'jpeg';
