...
export type BrandLegalEntityType = 'LIMITED_LIABILITY_COMPANY' | 'SOLE_PROPRIETORSHIP' | 'PARTNERSHIP' | 'CORPORATION' | 'S_CORPORATION';
export type BrandOrganizationType = 'PRIVATE_PROFIT' | 'PUBLIC_PROFIT' | 'NON_PROFIT' | 'GOVERNMENT' | 'UNKNOWN';
export interface BrandResponse {
    addresses: {
        [key: string]: BrandAddress;
    };
    brand_id: string;
    capabilities: AgentsAPI.CapabilitiesResponse;
    contacts: {
        [key: string]: BrandContact;
    };
    display_name: string;
    identifiers: {
        [key: string]: BrandIdentifier;
    };
    legal_entity_type: string;
    legal_name: string;
    organization_type: string;
    profile_id: string | null;
    status: 'CREATED' | 'CONFIGURED' | 'SUBMITTED' | 'REVIEWING' | 'VETTING' | 'VERIFIED' | 'REJECTED' | 'FAILED';
    website_url: string;
}
...
export declare namespace BrandCreateParams {
    /**
     * Named business contacts. Use the `brand` key for the required BRAND contact.
     */
    interface Contacts {
    ...
    namespace Contacts {
        interface Brand extends Omit<BrandsAPI.BrandContact, 'contact_type'> {
            contact_type?: 'BRAND';
        }
    }
    /**
    ...
    interface Identifiers {
        ...
        [k: string]: BrandsAPI.BrandIdentifier | BrandsAPI.EinBrandIdentifier | BrandsAPI.StockSymbolBrandIdentifier | undefined;
    }
}
...
export declare namespace BrandUpdateParams {
    /**
     * Named business contacts. Use the `brand` key for the required BRAND contact.
     */
    interface Contacts {
