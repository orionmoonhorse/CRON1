...
import * as TestDevicesAPI from "./test-devices.mjs";
import { TestDeviceCreateParams, TestDeviceDeleteParams, TestDeviceListResponse, TestDeviceResponse, TestDevices } from "./test-devices.mjs";
...
export declare class Agents extends APIResource {
    testDevices: TestDevicesAPI.TestDevices;
    /**
     ...
     * ```
     */
    retrieveCarrierApprovals(id: string, options?: RequestOptions): APIPromise<AgentRetrieveCarrierApprovalsResponse>;
    /**
...
export interface AgentConfiguration {
     ...
     */
    basics: AgentConfiguration.AgentPhoneContactRequirement | AgentConfiguration.AgentWebhookContactRequirement | AgentConfiguration.AgentProfileContactRequirement;
...
export declare namespace AgentConfiguration {
    interface AgentPhoneContactRequirement {
    ...
    interface AgentWebhookContactRequirement {
    ...
    interface AgentProfileContactRequirement {
...
export declare namespace AgentConsentConfiguration {
    interface OptInMethod {
...
export interface AgentInteraction {
    interaction_type: 'TRANSACTIONAL_UPDATES' | 'CUSTOMER_SUPPORT' | 'LOYALTY_OR_REWARD' | 'MARKETING_OR_PROMOTIONAL' | 'ACCOUNT_ALERTS' | 'TWO_WAY_CONVERSATION' | 'OTHER';
    /**
...
export interface AgentResponse {
    ...
    status: 'CREATED' | 'SUBMITTED' | 'VERIFYING' | 'VERIFIED' | 'LAUNCHING' | 'LAUNCHED' | 'LIVE' | 'REJECTED' | 'FAILED';
...
export declare namespace AgentLaunchParams {
    interface Campaign extends Omit<AgentsAPI.AgentCampaignConfiguration, 'agent_overview' | 'consent_settings'> {
...
export declare namespace Agents {
    export { type AgentCampaignConfiguration as AgentCampaignConfiguration, type AgentConfiguration as AgentConfiguration, type AgentConsentConfiguration as AgentConsentConfiguration, type AgentEmailContact as AgentEmailContact, type AgentInteraction as AgentInteraction, type AgentPhoneContact as AgentPhoneContact, type AgentResponse as AgentResponse, type AgentSubmissionStatus as AgentSubmissionStatus, type AgentTestingConfiguration as AgentTestingConfiguration, type AgentUseCase as AgentUseCase, type AgentWebsiteContact as AgentWebsiteContact, type CapabilitiesResponse as CapabilitiesResponse, type CarrierApprovalResponse as CarrierApprovalResponse, type RcsAgent as RcsAgent, type RcsAgentResponse as RcsAgentResponse, type AgentListResponse as AgentListResponse, type AgentRetrieveCarrierApprovalsResponse as AgentRetrieveCarrierApprovalsResponse, type AgentListParams as AgentListParams, type AgentCreateParams as AgentCreateParams, type AgentUpdateParams as AgentUpdateParams, type AgentLaunchParams as AgentLaunchParams, };
    export { TestDevices as TestDevices, type TestDeviceResponse as TestDeviceResponse, type TestDeviceListResponse as TestDeviceListResponse, type TestDeviceCreateParams as TestDeviceCreateParams, type TestDeviceDeleteParams as TestDeviceDeleteParams, };
}
