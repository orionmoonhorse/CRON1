 ...
 */
class TestDevices extends resource_1.APIResource {
    /**
     ...
     */
    list(id, options) {
        return this._client.get((0, path_1.path) `/rcs/agents/${id}/test_devices`, options);
    }
    /**
    ...
    create(id, body, options) {
        return this._client.post((0, path_1.path) `/rcs/agents/${id}/test_devices`, { body, ...options });
    }
    /**
     ...
     * ```
     */
    delete(testDeviceID, params, options) {
        const { id } = params;
        return this._client.delete((0, path_1.path) `/rcs/agents/${id}/test_devices/${testDeviceID}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
}
exports.TestDevices = TestDevices;
//# sourceMappingURL=test-devices.js.map