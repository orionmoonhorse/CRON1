...
class Brands extends resource_1.APIResource {
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/rcs/brands/${id}`, options);
    }
    /**
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/rcs/brands/${id}`, { body, ...options });
    }
    /**
     ...
     */
    submit(id, options) {
        return this._client.post((0, path_1.path) `/rcs/brands/${id}/submit`, options);
    }
}
