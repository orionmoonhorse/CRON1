 ...
 */
export declare class Research extends APIResource {
    /**
...
export declare namespace ResearchCreateResponse {
    /**
     * Synchronous research response (when `background` is false or unset).
     */
    interface ResearchResponseSync {
        /**
     ...
     */
    interface ResearchResponseAsync {
        /**
...
export declare namespace ResearchRetrieveResponse {
    interface Data {
        /**
         * Current status of the research task.
         */
...
export declare namespace Research {
    export { type ResearchCitation as ResearchCitation, type ResearchCreateResponse as ResearchCreateResponse, type ResearchRetrieveResponse as ResearchRetrieveResponse, type ResearchCreateParams as ResearchCreateParams, };
}
//# sourceMappingURL=research.d.mts.map