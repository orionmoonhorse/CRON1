...
import * as EmailValidationsAPI from "./email-validations.js";
import * as BatchAPI from "./batch.js";
import { Batch, BatchCreateParams, BatchCreateResponse, BatchRetrieveResponse, EmailValidationBatchStatus } from "./batch.js";
import { APIPromise } from "../../core/api-promise.js";
import { RequestOptions } from "../../internal/request-options.js";
/**
 * Validate email addresses synchronously or in asynchronous batches.
 */
export declare class EmailValidations extends APIResource {
     ...
     * ```
     */
    create(params: EmailValidationCreateParams, options?: RequestOptions): APIPromise<EmailValidationCreateResponse>;
}
...
export declare namespace EmailValidationChecks {
    interface Typo extends EmailValidationsAPI.EmailValidationCheck {
        /**
...
export declare namespace EmailValidationCreateResponse {
    interface Data {
...
export declare namespace EmailValidations {
    export { type EmailValidationCheck as EmailValidationCheck, type EmailValidationChecks as EmailValidationChecks, type EmailValidationCreateResponse as EmailValidationCreateResponse, type EmailValidationCreateParams as EmailValidationCreateParams, };
    export { Batch as Batch, type EmailValidationBatchStatus as EmailValidationBatchStatus, type BatchCreateResponse as BatchCreateResponse, type BatchRetrieveResponse as BatchRetrieveResponse, type BatchCreateParams as BatchCreateParams, };
}
//# sourceMappingURL=email-validations.d.ts.map