...
const ByPhoneNumberAPI = tslib_1.__importStar(require("./by-phone-number/by-phone-number.js"));
const by_phone_number_1 = require("./by-phone-number/by-phone-number.js");
...
class Verifications extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.byPhoneNumber = new ByPhoneNumberAPI.ByPhoneNumber(this._client);
    ...
    retrieve(verificationID, options) {
        return this._client.get((0, path_1.path) `/verifications/${verificationID}`, options);
    }
    /**
     ...
     * ```
     */
    triggerWhatsappVerification(body, options) {
        return this._client.post('/verifications/whatsapp', { body, ...options });
    }
}
exports.Verifications = Verifications;
Verifications.ByPhoneNumber = by_phone_number_1.ByPhoneNumber;
Verifications.Actions = actions_1.Actions;
