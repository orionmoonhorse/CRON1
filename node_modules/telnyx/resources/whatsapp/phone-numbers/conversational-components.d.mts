 ...
 */
export declare class ConversationalComponents extends APIResource {
    /**
     ...
     * ```
     */
    patchAll(phoneNumber: string, body: ConversationalComponentPatchAllParams, options?: RequestOptions): APIPromise<ConversationalComponentPatchAllResponse>;
}
...
export declare namespace WhatsappConversationalComponent {
    interface Command {
        command?: string;
        description?: string;
    }
...
export declare namespace ConversationalComponentPatchAllParams {
    interface Command {
        command?: string;
        description?: string;
    }
