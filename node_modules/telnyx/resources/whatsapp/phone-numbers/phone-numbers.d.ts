...
export declare class PhoneNumbers extends APIResource {
     ...
     * ```
     */
    retrieveConversationWindow(phoneNumber: string, query: PhoneNumberRetrieveConversationWindowParams, options?: RequestOptions): APIPromise<PhoneNumberRetrieveConversationWindowResponse>;
    /**
     ...
     * ```
     */
    get(query?: PhoneNumberGetParams | null | undefined, options?: RequestOptions): APIPromise<PhoneNumberGetResponse>;
}
...
export declare namespace PhoneNumberGetResponse {
    interface Data {
        calling_enabled?: boolean;
        created_at?: string;
        display_name?: string;
...
export declare namespace PhoneNumberRetrieveConversationWindowResponse {
    interface Data {
        /**
