...
export declare namespace WhatsappTemplateBodyComponent {
    /**
     * Sample values for body variables. Required when body text contains parameters.
     */
    interface Example {
...
export declare namespace WhatsappTemplateButtonsComponent {
    interface Button {
...
export declare namespace WhatsappTemplateCarouselComponent {
    interface Card {
        components?: Array<{
            [key: string]: unknown;
        }>;
...
export declare namespace WhatsappTemplateHeaderComponent {
    /**
     * Sample values for header variables.
     */
    interface Example {
...
export interface TemplateCreateParams {
     ...
     */
    components: Array<WhatsappTemplateHeaderComponent | WhatsappTemplateBodyComponent | WhatsappTemplateFooterComponent | WhatsappTemplateButtonsComponent | WhatsappTemplateCarouselComponent>;
    /**
...
export declare namespace Templates {
    export { type WhatsappTemplateBodyComponent as WhatsappTemplateBodyComponent, type WhatsappTemplateButtonsComponent as WhatsappTemplateButtonsComponent, type WhatsappTemplateCarouselComponent as WhatsappTemplateCarouselComponent, type WhatsappTemplateFooterComponent as WhatsappTemplateFooterComponent, type WhatsappTemplateHeaderComponent as WhatsappTemplateHeaderComponent, type TemplateCreateResponse as TemplateCreateResponse, type TemplateListParams as TemplateListParams, type TemplateCreateParams as TemplateCreateParams, };
}
