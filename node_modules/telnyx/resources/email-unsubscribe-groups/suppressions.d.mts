...
import * as EmailBlocksAPI from "../email-blocks/email-blocks.mjs";
import { EmailBlocksDefaultFlatPagination } from "../email-blocks/email-blocks.mjs";
...
export declare class Suppressions extends APIResource {
     ...
     * ```
     */
    list(id: string, query?: SuppressionListParams | null | undefined, options?: RequestOptions): PagePromise<EmailBlocksDefaultFlatPagination, EmailBlocksAPI.EmailBlock>;
    /**
     ...
     * ```
     */
    create(id: string, body: SuppressionCreateParams, options?: RequestOptions): APIPromise<EmailBlocksAPI.EmailBlockResponse>;
    /**
...
export declare namespace Suppressions {
    export { type SuppressionListParams as SuppressionListParams, type SuppressionCreateParams as SuppressionCreateParams, type SuppressionDeleteParams as SuppressionDeleteParams, };
}
