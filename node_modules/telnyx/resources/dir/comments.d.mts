...
export declare class Comments extends APIResource {
     ...
     * ```
     */
    list(dirID: string, query?: CommentListParams | null | undefined, options?: RequestOptions): PagePromise<DirCommentsDefaultFlatPagination, DirComment>;
    /**
     ...
     * ```
     */
    create(dirID: string, body: CommentCreateParams, options?: RequestOptions): APIPromise<CommentCreateResponse>;
}
 ...
 */
export type CommentType = 'vetting_comment' | 'rejection_reason' | 'internal_note' | 'notification' | 'status_update' | 'customer_inquiry' | 'admin_response';
...
export declare namespace Comments {
    export { type CommentType as CommentType, type DirComment as DirComment, type CommentCreateResponse as CommentCreateResponse, type DirCommentsDefaultFlatPagination as DirCommentsDefaultFlatPagination, type CommentListParams as CommentListParams, type CommentCreateParams as CommentCreateParams, };
}
