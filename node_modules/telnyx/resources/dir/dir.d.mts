...
import * as CallReasonsAPI from "../call-reasons.mjs";
import * as InfringementClaimsAPI from "../infringement-claims.mjs";
import { InfringementClaimsDefaultFlatPagination } from "../infringement-claims.mjs";
import * as CommentsAPI from "./comments.mjs";
import { CommentCreateParams, CommentCreateResponse, CommentListParams, CommentType, Comments, DirComment, DirCommentsDefaultFlatPagination } from "./comments.mjs";
import * as PhoneNumberBatchesAPI from "./phone-number-batches.mjs";
import { DirPhoneNumberStatus, PhoneNumberBatch, PhoneNumberBatchListParams, PhoneNumberBatchRetrieveParams, PhoneNumberBatchRetrieveResponse, PhoneNumberBatches, PhoneNumberBatchesDefaultFlatPagination } from "./phone-number-batches.mjs";
import * as PhoneNumbersAPI from "./phone-numbers.mjs";
import { DirPhoneNumber, DirPhoneNumbersDefaultFlatPagination, PhoneNumberAddParams, PhoneNumberAddResponse, PhoneNumberListParams, PhoneNumberRemoveParams, PhoneNumberRemoveResponse, PhoneNumbers, RejectionReason } from "./phone-numbers.mjs";
import * as ReferencesAPI from "./references.mjs";
import { Reference, ReferenceCreateParams, ReferenceInput, ReferenceList, ReferenceUpdateParams, ReferenceUpdateResponse, References } from "./references.mjs";
import * as VerifyEmailAPI from "./verify-email.mjs";
import { EmailVerificationStatus, EmailVerificationStatusWrapped, VerifyEmail, VerifyEmailConfirmParams } from "./verify-email.mjs";
import * as LoaAPI from "../enterprises/reputation/loa.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { DefaultFlatPagination, type DefaultFlatPaginationParams, PagePromise } from "../../core/pagination.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class DirResource extends APIResource {
    comments: CommentsAPI.Comments;
    phoneNumberBatches: PhoneNumberBatchesAPI.PhoneNumberBatches;
    phoneNumbers: PhoneNumbersAPI.PhoneNumbers;
    references: ReferencesAPI.References;
    verifyEmail: VerifyEmailAPI.VerifyEmail;
    /**
     ...
     * ```
     */
    list(query?: DirListParams | null | undefined, options?: RequestOptions): PagePromise<DirsDefaultFlatPagination, Dir>;
    /**
     ...
     * ```
     */
    listInfringementClaims(dirID: string, query?: DirListInfringementClaimsParams | null | undefined, options?: RequestOptions): PagePromise<InfringementClaimsDefaultFlatPagination, InfringementClaimsAPI.InfringementClaim>;
    /**
     ...
     * ```
     */
    updateInfringement(dirID: string, body: DirUpdateInfringementParams, options?: RequestOptions): APIPromise<DirWrapped>;
    /**
 ...
 * - `permanently_rejected` - terminal; cannot be resubmitted.
 */
export type DirStatus = 'draft' | 'submitted' | 'in_review' | 'verified' | 'rejected' | 'unsuccessful' | 'suspended' | 'expired' | 'infringement_claimed' | 'permanently_rejected';
...
export declare namespace DirListDocumentTypesResponse {
    /**
...
export declare namespace DirNewLoaParams {
    /**
     * Optional. When provided the rendered PDF embeds the signature image, printed
     * name, and signed-at date. When absent the PDF is returned unsigned so the
     * customer can sign externally and upload it via the Documents API.
...
export declare namespace DirResource {
    export { type Dir as Dir, type DirList as DirList, type DirStatus as DirStatus, type DirWrapped as DirWrapped, type Document as Document, type DirListDocumentTypesResponse as DirListDocumentTypesResponse, type DirsDefaultFlatPagination as DirsDefaultFlatPagination, type DirListParams as DirListParams, type DirUpdateParams as DirUpdateParams, type DirListInfringementClaimsParams as DirListInfringementClaimsParams, type DirUpdateInfringementParams as DirUpdateInfringementParams, type DirNewLoaParams as DirNewLoaParams, };
    export { Comments as Comments, type CommentType as CommentType, type DirComment as DirComment, type CommentCreateResponse as CommentCreateResponse, type DirCommentsDefaultFlatPagination as DirCommentsDefaultFlatPagination, type CommentListParams as CommentListParams, type CommentCreateParams as CommentCreateParams, };
    export { PhoneNumberBatches as PhoneNumberBatches, type DirPhoneNumberStatus as DirPhoneNumberStatus, type PhoneNumberBatch as PhoneNumberBatch, type PhoneNumberBatchRetrieveResponse as PhoneNumberBatchRetrieveResponse, type PhoneNumberBatchesDefaultFlatPagination as PhoneNumberBatchesDefaultFlatPagination, type PhoneNumberBatchListParams as PhoneNumberBatchListParams, type PhoneNumberBatchRetrieveParams as PhoneNumberBatchRetrieveParams, };
    export { PhoneNumbers as PhoneNumbers, type DirPhoneNumber as DirPhoneNumber, type RejectionReason as RejectionReason, type PhoneNumberAddResponse as PhoneNumberAddResponse, type PhoneNumberRemoveResponse as PhoneNumberRemoveResponse, type DirPhoneNumbersDefaultFlatPagination as DirPhoneNumbersDefaultFlatPagination, type PhoneNumberRemoveParams as PhoneNumberRemoveParams, type PhoneNumberListParams as PhoneNumberListParams, type PhoneNumberAddParams as PhoneNumberAddParams, };
    export { References as References, type Reference as Reference, type ReferenceInput as ReferenceInput, type ReferenceList as ReferenceList, type ReferenceUpdateResponse as ReferenceUpdateResponse, type ReferenceCreateParams as ReferenceCreateParams, type ReferenceUpdateParams as ReferenceUpdateParams, };
    export { VerifyEmail as VerifyEmail, type EmailVerificationStatus as EmailVerificationStatus, type EmailVerificationStatusWrapped as EmailVerificationStatusWrapped, type VerifyEmailConfirmParams as VerifyEmailConfirmParams, };
}
export { type InfringementClaimsDefaultFlatPagination };
//# sourceMappingURL=dir.d.mts.map