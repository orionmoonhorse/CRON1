...
export declare class PhoneNumbers extends APIResource {
     ...
     * ```
     */
    remove(dirID: string, body: PhoneNumberRemoveParams, options?: RequestOptions): APIPromise<PhoneNumberRemoveResponse>;
    /**
     ...
     * ```
     */
    list(dirID: string, query?: PhoneNumberListParams | null | undefined, options?: RequestOptions): PagePromise<DirPhoneNumbersDefaultFlatPagination, DirPhoneNumber>;
    /**
     ...
     * ```
     */
    add(dirID: string, body: PhoneNumberAddParams, options?: RequestOptions): APIPromise<PhoneNumberAddResponse>;
}
...
export declare namespace PhoneNumberRemoveResponse {
    interface Meta {
        /**
