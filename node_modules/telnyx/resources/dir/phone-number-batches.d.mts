 ...
 */
export declare class PhoneNumberBatches extends APIResource {
    /**
     ...
     * ```
     */
    list(dirID: string, query?: PhoneNumberBatchListParams | null | undefined, options?: RequestOptions): PagePromise<PhoneNumberBatchesDefaultFlatPagination, PhoneNumberBatch>;
    /**
     ...
     * ```
     */
    retrieve(batchID: string, params: PhoneNumberBatchRetrieveParams, options?: RequestOptions): APIPromise<PhoneNumberBatchRetrieveResponse>;
}
 ...
 *   you own.
 */
export type DirPhoneNumberStatus = 'submitted' | 'in_review' | 'verified' | 'unsuccessful' | 'suspended' | 'expired' | 'permanently_rejected';
/**
