...
export class Events extends APIResource {
    ...
    list(runID, params, options) {
        ...
        return this._client.getAPIList(path `/ai/missions/${mission_id}/runs/${runID}/events`, (DefaultFlatPagination), { query, ...options });
    }
    /**
     ...
     * ```
     */
    getEventDetails(eventID, params, options) {
