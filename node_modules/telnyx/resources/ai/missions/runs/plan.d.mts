...
export declare class Plan extends APIResource {
     ...
     * ```
     */
    create(runID: string, params: PlanCreateParams, options?: RequestOptions): APIPromise<PlanStepsCreatedResponse>;
    /**
     ...
     * ```
     */
    updateStep(stepID: string, params: PlanUpdateStepParams, options?: RequestOptions): APIPromise<PlanStepResponse>;
    /**
     ...
     * ```
     */
    addStepsToPlan(runID: string, params: PlanAddStepsToPlanParams, options?: RequestOptions): APIPromise<PlanStepsCreatedResponse>;
    /**
     ...
     * ```
     */
    getStepDetails(stepID: string, params: PlanGetStepDetailsParams, options?: RequestOptions): APIPromise<PlanStepResponse>;
}
