...
import { BucketIDs, Chat, ChatCompletionRequest } from "./chat.mjs";
...
import { McpServer, McpServerCreateParams, McpServerListParams, McpServerUpdateParams, McpServers, McpServersDefaultFlatPaginationTopLevelArray } from "./mcp-servers.mjs";
import * as ToolsAPI from "./tools.mjs";
import { PayToolParams, SharedToolResponse, SharedToolResponsesDefaultFlatPagination, ToolCreateParams, ToolDeleteResponse, ToolListParams, ToolUpdateParams, Tools, UpdateDynamicVariablesToolParams } from "./tools.mjs";
...
import { ArithmeticExpression, Assistant, AssistantChatParams, AssistantChatResponse, AssistantCloneParams, AssistantCreateParams, AssistantDeleteResponse, AssistantGetTexmlResponse, AssistantImportsParams, AssistantIntegration, AssistantMcpServer, AssistantRetrieveParams, AssistantSendSMSParams, AssistantSendSMSResponse, AssistantTool, AssistantUpdateParams, Assistants, AssistantsList, AudioVisualizerConfig, AuthenticationMethod, BooleanOpExpression, ComparisonExpression, ConversationFlow, ConversationFlowReq, EnabledFeatures, Expression, ExternalLlm, ExternalLlmReq, FallbackConfig, FallbackConfigReq, FlowEdge, FlowNode, FlowNodeReq, HangupTool, HangupToolParams, ImportMetadata, InferenceEmbedding, InferenceEmbeddingInterruptionSettings, InferenceEmbeddingWebhookToolParams, InsightSettings, MessagingSettings, NodePosition, Observability, ObservabilityReq, ObservabilityStatus, PostConversationSettings, PostConversationSettingsReq, PrivacySettings, PromptSyncStatus, RetrievalTool, SpeakNode, SpeakNodeReq, StartSpeakingPlan, TelephonySettings, ToolNode, ToolNodeReq, TranscriptionEndpointingPlan, TranscriptionSettings, TranscriptionSettingsConfig, TransferTool, VoiceSettings, WebhookTool, WidgetSettings } from "./assistants/assistants.mjs";
import * as CollectionsAPI from "./collections/collections.mjs";
import { Collection, CollectionCreateParams, CollectionEnvelope, CollectionListParams, CollectionUpdateParams, Collections, CollectionsDefaultFlatPagination } from "./collections/collections.mjs";
...
import { Integration, IntegrationListResponse, Integrations } from "./integrations/integrations.mjs";
...
import { EventsListResponse, ExecutionMode, MissionCloneMissionResponse, MissionCreateParams, MissionData, MissionDataDefaultFlatPagination, MissionListEventsParams, MissionListParams, MissionResponse, MissionUpdateMissionParams, Missions } from "./missions/missions.mjs";
import * as OpenAIAPI from "./openai/openai.mjs";
import { OpenAI, OpenAICreateResponseParams, OpenAICreateResponseResponse } from "./openai/openai.mjs";
...
export declare class AI extends APIResource {
    ...
    anthropic: AnthropicAPI.Anthropic;
     ...
     * ```
     */
    retrieveConversationHistories(query: AIRetrieveConversationHistoriesParams, options?: RequestOptions): PagePromise<AIRetrieveConversationHistoriesResponsesDefaultFlatPagination, AIRetrieveConversationHistoriesResponse>;
}
export type AIRetrieveConversationHistoriesResponsesDefaultFlatPagination = DefaultFlatPagination<AIRetrieveConversationHistoriesResponse>;
/**
...
export declare namespace AI {
    ...
    export { Collections as Collections, type Collection as Collection, type CollectionEnvelope as CollectionEnvelope, type CollectionsDefaultFlatPagination as CollectionsDefaultFlatPagination, type CollectionListParams as CollectionListParams, type CollectionCreateParams as CollectionCreateParams, type CollectionUpdateParams as CollectionUpdateParams, };
    ...
    export { Tools as Tools, type PayToolParams as PayToolParams, type SharedToolResponse as SharedToolResponse, type UpdateDynamicVariablesToolParams as UpdateDynamicVariablesToolParams, type ToolDeleteResponse as ToolDeleteResponse, type SharedToolResponsesDefaultFlatPagination as SharedToolResponsesDefaultFlatPagination, type ToolListParams as ToolListParams, type ToolCreateParams as ToolCreateParams, type ToolUpdateParams as ToolUpdateParams, };
