...
import { InstructionEnhanceParams, InstructionEnhanceResponse, Instructions } from "./instructions.mjs";
import * as ScheduledEventsAPI from "./scheduled-events.mjs";
import { ConversationChannelType, EventStatus, ScheduledCallSettings, ScheduledEventCreateParams, ScheduledEventDeleteParams, ScheduledEventListParams, ScheduledEventListResponse, ScheduledEventListResponsesDefaultFlatPagination, ScheduledEventResponse, ScheduledEventRetrieveParams, ScheduledEvents, ScheduledPhoneCallEventResponse, ScheduledSMSEventResponse } from "./scheduled-events.mjs";
import * as TagsAPI from "./tags.mjs";
import { TagAddParams, TagRemoveParams, Tags, TagsResponse } from "./tags.mjs";
...
export declare class Assistants extends APIResource {
    ...
    tools: AssistantsToolsAPI.Tools;
     ...
     * ```
     */
    clone(assistantID: string, params?: AssistantCloneParams | null | undefined, options?: RequestOptions): APIPromise<InferenceEmbedding>;
    /**
     ...
     * ```
     */
    sendSMS(assistantID: string, params: AssistantSendSMSParams, options?: RequestOptions): APIPromise<AssistantSendSMSResponse>;
}
/**
 ...
 * user.
 */
export type AssistantTool = InferenceEmbeddingWebhookToolParams | AssistantTool.ClientSideTool | RetrievalTool | AssistantTool.Handoff | HangupTool | AssistantTool.Transfer | AssistantTool.Invite | AssistantTool.Refer | AssistantTool.SendDtmf | AssistantTool.SendMessage | AssistantTool.SkipTurn | AssistantTool.Pay | AssistantTool.UpdateDynamicVariables;
export declare namespace AssistantTool {
    ...
    namespace Transfer {
        ...
        namespace Transfer {
             ...
             * additional invited participants fall back to a regular warm transfer).
             */
            interface WarmTransferAcceptance {
                /**
     ...
     */
    interface UpdateDynamicVariables {
 ...
 */
export type Expression = ComparisonExpression | BooleanOpExpression | ArithmeticExpression | Expression.DynamicVariableExpression | Expression.StringLiteralExpression | Expression.NumberLiteralExpression | Expression.BooleanLiteralExpression;
export declare namespace Expression {
     ...
     */
    interface DynamicVariableExpression {
        /**
...
export declare namespace FlowEdge {
    /**
...
export declare namespace InferenceEmbeddingWebhookToolParams {
    interface Webhook {
         ...
         */
        messages?: Array<Webhook.WebhookToolRequestStartMessage | Webhook.WebhookToolRequestResponseDelayedMessage>;
        /**
    ...
    namespace Webhook {
        ...
        interface WebhookToolRequestStartMessage {
            /**
        ...
        interface WebhookToolRequestResponseDelayedMessage {
            /**
             * The text the assistant speaks.
             */
            content: string;
