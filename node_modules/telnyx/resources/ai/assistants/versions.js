...
class Versions extends resource_1.APIResource {
    ...
    list(assistantID, options) {
        return this._client.get((0, path_1.path) `/ai/assistants/${assistantID}/versions`, options);
    }
    /**
    ...
    delete(versionID, params, options) {
        ...
        return this._client.delete((0, path_1.path) `/ai/assistants/${assistant_id}/versions/${versionID}`, {
            ...options,
    ...
    retrieve(versionID, params, options) {
        ...
        return this._client.get((0, path_1.path) `/ai/assistants/${assistant_id}/versions/${versionID}`, {
            query,
            ...options,
        });
    }
    ...
    update(versionID, params, options) {
        ...
        return this._client.post((0, path_1.path) `/ai/assistants/${assistant_id}/versions/${versionID}`, {
            body,
            ...options,
        });
    }
    ...
    promote(versionID, params, options) {
        const { assistant_id } = params;
        return this._client.post((0, path_1.path) `/ai/assistants/${assistant_id}/versions/${versionID}/promote`, options);
    }
}
