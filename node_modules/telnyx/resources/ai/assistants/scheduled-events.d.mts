...
export declare class ScheduledEvents extends APIResource {
     ...
     * ```
     */
    create(assistantID: string, params: ScheduledEventCreateParams, options?: RequestOptions): APIPromise<ScheduledEventResponse>;
    /**
