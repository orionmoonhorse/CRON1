 ...
 */
export declare class Instructions extends APIResource {
    /**
     ...
     * ```
     */
    enhance(assistantID: string, body?: InstructionEnhanceParams | null | undefined, options?: RequestOptions): APIPromise<string>;
}
...
export declare namespace Instructions {
    export { type InstructionEnhanceResponse as InstructionEnhanceResponse, type InstructionEnhanceParams as InstructionEnhanceParams, };
}
