...
const InstructionsAPI = tslib_1.__importStar(require("./instructions.js"));
...
const AssistantsToolsAPI = tslib_1.__importStar(require("./tools.js"));
...
class Assistants extends resource_1.APIResource {
    ...
    clone(assistantID, params = {}, options) {
        ...
        return this._client.post((0, path_1.path) `/ai/assistants/${assistantID}/clone`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([
                { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
                options?.headers,
    ...
    sendSMS(assistantID, params, options) {
        const { 'Idempotency-Key': idempotencyKey, ...body } = params;
        return this._client.post((0, path_1.path) `/ai/assistants/${assistantID}/chat/sms`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([
                { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
...
Assistants.Instructions = instructions_1.Instructions;
