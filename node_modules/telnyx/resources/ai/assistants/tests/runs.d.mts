...
export declare class Runs extends APIResource {
     ...
     * ```
     */
    trigger(testID: string, params?: RunTriggerParams | null | undefined, options?: RequestOptions): APIPromise<TestRunResponse>;
    /**
...
export declare namespace Runs {
    export { type TestRunDetailResult as TestRunDetailResult, type TestRunResponse as TestRunResponse, type TestStatus as TestStatus, type TestRunResponsesDefaultFlatPagination as TestRunResponsesDefaultFlatPagination, type RunListParams as RunListParams, type RunTriggerParams as RunTriggerParams, type RunRetrieveParams as RunRetrieveParams, };
}
