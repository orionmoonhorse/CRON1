 ...
 */
class ScheduledEvents extends resource_1.APIResource {
    /**
    ...
    list(assistantID, query = {}, options) {
        return this._client.getAPIList((0, path_1.path) `/ai/assistants/${assistantID}/scheduled_events`, (pagination_1.DefaultFlatPagination), { query, ...options });
    }
    /**
    ...
    create(assistantID, params, options) {
        ...
        return this._client.post((0, path_1.path) `/ai/assistants/${assistantID}/scheduled_events`, {
            body,
            ...options,
    ...
    delete(eventID, params, options) {
        ...
        return this._client.delete((0, path_1.path) `/ai/assistants/${assistant_id}/scheduled_events/${eventID}`, {
            ...options,
    ...
    retrieve(eventID, params, options) {
        const { assistant_id } = params;
        return this._client.get((0, path_1.path) `/ai/assistants/${assistant_id}/scheduled_events/${eventID}`, options);
    }
}
