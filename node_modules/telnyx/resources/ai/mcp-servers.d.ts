...
import { DefaultFlatPaginationTopLevelArray, type DefaultFlatPaginationTopLevelArrayParams, PagePromise } from "../../core/pagination.js";
...
export declare class McpServers extends APIResource {
     ...
     * ```
     */
    list(query?: McpServerListParams | null | undefined, options?: RequestOptions): PagePromise<McpServersDefaultFlatPaginationTopLevelArray, McpServer>;
    /**
...
export declare namespace McpServers {
    export { type McpServer as McpServer, type McpServersDefaultFlatPaginationTopLevelArray as McpServersDefaultFlatPaginationTopLevelArray, type McpServerListParams as McpServerListParams, type McpServerCreateParams as McpServerCreateParams, type McpServerUpdateParams as McpServerUpdateParams, };
}
