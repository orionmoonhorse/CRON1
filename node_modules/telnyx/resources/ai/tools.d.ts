...
export declare class Tools extends APIResource {
     ...
     * ```
     */
    list(query?: ToolListParams | null | undefined, options?: RequestOptions): PagePromise<SharedToolResponsesDefaultFlatPagination, SharedToolResponse>;
    /**
...
export declare namespace UpdateDynamicVariablesToolParams {
    interface UpdatableVariable {
        /**
