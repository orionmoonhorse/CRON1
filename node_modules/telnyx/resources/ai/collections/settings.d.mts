...
export declare class Settings extends APIResource {
     ...
     * ```
     */
    patchAll(uuid: string, body: SettingPatchAllParams, options?: RequestOptions): APIPromise<SettingsEnvelope>;
    /**
...
export declare namespace Settings {
    export { type RetrievalSettings as RetrievalSettings, type RetrievalSettingsWrapper as RetrievalSettingsWrapper, type SettingsEnvelope as SettingsEnvelope, type SettingsRequest as SettingsRequest, type SettingPatchAllParams as SettingPatchAllParams, type SettingCreateParams as SettingCreateParams, };
}
