...
import { RetrievalSettings, RetrievalSettingsWrapper, SettingCreateParams, SettingPatchAllParams, Settings, SettingsEnvelope, SettingsRequest } from "./settings.mjs";
import * as SourcesAPI from "./sources.mjs";
import { Source, SourceCreateParams, SourceCreateResponse, SourceDeleteParams, SourceListResponse, SourceReplaceParams, SourceReplaceResponse, SourceRequest, SourceType, Sources } from "./sources.mjs";
...
export declare class Collections extends APIResource {
     ...
     * ```
     */
    list(query?: CollectionListParams | null | undefined, options?: RequestOptions): PagePromise<CollectionsDefaultFlatPagination, Collection>;
    /**
     ...
     * ```
     */
    update(uuid: string, body: CollectionUpdateParams, options?: RequestOptions): APIPromise<CollectionEnvelope>;
}
...
export declare namespace Collections {
    export { type Collection as Collection, type CollectionEnvelope as CollectionEnvelope, type CollectionsDefaultFlatPagination as CollectionsDefaultFlatPagination, type CollectionListParams as CollectionListParams, type CollectionCreateParams as CollectionCreateParams, type CollectionUpdateParams as CollectionUpdateParams, };
    export { Settings as Settings, type RetrievalSettings as RetrievalSettings, type RetrievalSettingsWrapper as RetrievalSettingsWrapper, type SettingsEnvelope as SettingsEnvelope, type SettingsRequest as SettingsRequest, type SettingPatchAllParams as SettingPatchAllParams, type SettingCreateParams as SettingCreateParams, };
    export { Sources as Sources, type Source as Source, type SourceRequest as SourceRequest, type SourceType as SourceType, type SourceCreateResponse as SourceCreateResponse, type SourceListResponse as SourceListResponse, type SourceReplaceResponse as SourceReplaceResponse, type SourceCreateParams as SourceCreateParams, type SourceReplaceParams as SourceReplaceParams, type SourceDeleteParams as SourceDeleteParams, };
}
