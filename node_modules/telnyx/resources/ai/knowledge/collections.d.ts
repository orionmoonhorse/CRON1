...
export declare class Collections extends APIResource {
     ...
     * ```
     */
    retrieveDocuments(slug: string, query?: CollectionRetrieveDocumentsParams | null | undefined, options?: RequestOptions): APIPromise<CollectionRetrieveDocumentsResponse>;
}
...
export declare namespace CollectionRetrieveDocumentsResponse {
    interface Data {
        id?: string;
        chunk_index?: number;
        chunk_total?: number;
...
export declare namespace Collections {
    export { type CollectionRetrieveDocumentsResponse as CollectionRetrieveDocumentsResponse, type CollectionRetrieveDocumentsParams as CollectionRetrieveDocumentsParams, };
}
