...
export declare class PronunciationDicts extends APIResource {
     ...
     * ```
     */
    create(body: PronunciationDictCreateParams, options?: RequestOptions): APIPromise<PronunciationDictResponse>;
    /**
     ...
     * ```
     */
    update(id: string, body: PronunciationDictUpdateParams, options?: RequestOptions): APIPromise<PronunciationDictResponse>;
}
