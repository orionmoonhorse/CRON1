...
import * as EmailTemplatesAPI from "./email-templates.mjs";
 ...
 */
export declare class EmailTemplates extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: EmailTemplateListParams | null | undefined, options?: RequestOptions): PagePromise<EmailTemplatesEmailCursorPagination, EmailTemplate>;
    /**
     ...
     * ```
     */
    replace(id: string, body: EmailTemplateReplaceParams, options?: RequestOptions): APIPromise<EmailTemplateResponse>;
    /**
     ...
     * ```
     */
    update(id: string, body: EmailTemplateUpdateParams, options?: RequestOptions): APIPromise<EmailTemplateResponse>;
    /**
     ...
     * ```
     */
    render(id: string, body?: EmailTemplateRenderParams | null | undefined, options?: RequestOptions): APIPromise<EmailTemplateRenderResponse>;
}
...
export declare namespace EmailTemplateRenderResponse {
    /**
     * Template object with `subject`, `html_body`, and `text_body` replaced by their
     * Liquid-rendered values. All other template fields (id, name, variables, etc.)
     * remain unchanged.
     */
    interface Data extends EmailTemplatesAPI.EmailTemplate {
    }
}
