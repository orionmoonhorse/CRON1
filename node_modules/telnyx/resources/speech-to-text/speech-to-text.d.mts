...
export declare class SpeechToText extends APIResource {
     ...
     */
    retrieveTranscription(query: SpeechToTextRetrieveTranscriptionParams, options?: RequestOptions): APIPromise<void>;
}
/**
...
/**
 * Binary audio data in mp3, wav, linear16, or linear32 format, per `input_format`.
 */
...
export declare namespace TranscribeServerEvent {
    ...
    interface TranscriptFrame {
        ...
        type: 'transcript';
        /**
         * Confidence score of the transcription, ranging from 0 to 1. `cohere/ar-stt`
         * frames return `null` here rather than omitting the field.
         */
...
export interface SpeechToTextListProvidersParams {
     ...
     */
    provider?: 'deepgram' | 'speechmatics' | 'assemblyai' | 'xai' | 'soniox' | 'parakeet' | 'humain' | 'reson8' | 'cohere' | 'azure' | 'openai' | 'google' | 'telnyx';
    /**
...
export interface SpeechToTextRetrieveTranscriptionParams {
     ...
     */
    input_format: 'mp3' | 'wav' | 'linear16' | 'linear32';
    /**
     * The transcription engine to use for processing the audio stream.
     */
    transcription_engine: 'Azure' | 'Deepgram' | 'Google' | 'Telnyx' | 'xAI' | 'Speechmatics' | 'Soniox' | 'Parakeet' | 'Humain' | 'Reson8' | 'Cohere';
    /**
     ...
     */
    model?: 'fast' | 'deepgram/nova-2' | 'deepgram/nova-3' | 'latest_long' | 'latest_short' | 'command_and_search' | 'phone_call' | 'video' | 'default' | 'medical_conversation' | 'medical_dictation' | 'openai/whisper-tiny' | 'openai/whisper-large-v3-turbo' | 'xai/grok-stt' | 'speechmatics/standard' | 'soniox/stt-rt-v4' | 'nvidia/parakeet-v3' | 'humain/realtime' | 'reson8/turns' | 'cohere/ar-stt';
    /**
