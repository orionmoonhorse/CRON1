...
export declare class VoiceClones extends APIResource {
     ...
     * ```
     */
    createFromUpload(params: VoiceCloneCreateFromUploadParams, options?: RequestOptions): APIPromise<VoiceCloneResponse>;
    /**
...
export interface VoiceCloneCreateFromUploadParams {
     ...
     */
    voice_clone_upload_request: VoiceCloneCreateFromUploadParams.TelnyxQwen3TtsClone | VoiceCloneCreateFromUploadParams.TelnyxUltraClone | VoiceCloneCreateFromUploadParams.MinimaxClone;
}
