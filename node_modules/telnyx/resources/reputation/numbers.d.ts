...
import * as ReputationNumbersAPI from "../enterprises/reputation/numbers.js";
import { ReputationPhoneNumbersDefaultFlatPagination } from "../enterprises/reputation/numbers.js";
...
export declare class Numbers extends APIResource {
     ...
     */
    list(query?: NumberListParams | null | undefined, options?: RequestOptions): PagePromise<ReputationPhoneNumbersDefaultFlatPagination, ReputationNumbersAPI.ReputationPhoneNumber>;
    /**
     ...
     */
    retrieve(phoneNumber: string, query?: NumberRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<ReputationNumbersAPI.ReputationPhoneNumberWithReputation>;
}
