...
import { InboundThreadsEmailBracketCursorPagination } from "./email-inboxes/threads/threads.mjs";
 ...
 */
export declare class EmailThreads extends APIResource {
    /**
     ...
     */
    list(query?: EmailThreadListParams | null | undefined, options?: RequestOptions): PagePromise<InboundThreadsEmailBracketCursorPagination, ThreadsAPI.InboundThread>;
    /**
     ...
     */
    retrieve(threadID: string, query: EmailThreadRetrieveParams, options?: RequestOptions): APIPromise<EmailThreadRetrieveResponse>;
}
...
export declare namespace EmailThreads {
    export { type EmailThreadRetrieveResponse as EmailThreadRetrieveResponse, type EmailThreadListParams as EmailThreadListParams, type EmailThreadRetrieveParams as EmailThreadRetrieveParams, };
}
export { type InboundThreadsEmailBracketCursorPagination };
//# sourceMappingURL=email-threads.d.mts.map