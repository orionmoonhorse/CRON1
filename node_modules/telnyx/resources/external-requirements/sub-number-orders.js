...
class SubNumberOrders extends resource_1.APIResource {
     ...
     * ```
     */
    retrieve(subNumberOrderID, params, options) {
        const { regulatory_requirement_id } = params;
        return this._client.get((0, path_1.path) `/external_requirements/${regulatory_requirement_id}/sub_number_orders/${subNumberOrderID}`, options);
    }
    /**
     ...
     * ```
     */
    update(subNumberOrderID, params, options) {
        const { regulatory_requirement_id, ...body } = params;
        return this._client.post((0, path_1.path) `/external_requirements/${regulatory_requirement_id}/sub_number_orders/${subNumberOrderID}`, { body, ...options });
    }
}
