...
export declare class SubNumberOrders extends APIResource {
     ...
     * ```
     */
    retrieve(subNumberOrderID: string, params: SubNumberOrderRetrieveParams, options?: RequestOptions): APIPromise<SubNumberOrderRetrieveResponse>;
    /**
     ...
     * ```
     */
    update(subNumberOrderID: string, params: SubNumberOrderUpdateParams, options?: RequestOptions): APIPromise<SubNumberOrderUpdateResponse>;
}
export interface SubNumberOrderRetrieveResponse {
    data?: SubNumberOrderRetrieveResponse.Data;
}
export declare namespace SubNumberOrderRetrieveResponse {
    interface Data {
        /**
...
export declare namespace SubNumberOrderUpdateResponse {
    interface Data {
        regulatory_requirement_id?: string;
        requirement_action?: Data.RequirementAction;
        sub_order_id?: string;
...
export declare namespace SubNumberOrderUpdateParams {
    /**
...
export declare namespace SubNumberOrders {
    export { type SubNumberOrderRetrieveResponse as SubNumberOrderRetrieveResponse, type SubNumberOrderUpdateResponse as SubNumberOrderUpdateResponse, type SubNumberOrderRetrieveParams as SubNumberOrderRetrieveParams, type SubNumberOrderUpdateParams as SubNumberOrderUpdateParams, };
}
