...
export declare class AdvancedOrders extends APIResource {
     ...
     * ```
     */
    updateRequirementGroup(advancedOrderID: string, body: AdvancedOrderUpdateRequirementGroupParams, options?: RequestOptions): APIPromise<AdvancedOrder>;
}
...
export declare namespace AdvancedOrders {
    export { type AdvancedOrder as AdvancedOrder, type AdvancedOrderRequest as AdvancedOrderRequest, type AdvancedOrderListResponse as AdvancedOrderListResponse, type AdvancedOrderCreateParams as AdvancedOrderCreateParams, type AdvancedOrderUpdateRequirementGroupParams as AdvancedOrderUpdateRequirementGroupParams, };
}
