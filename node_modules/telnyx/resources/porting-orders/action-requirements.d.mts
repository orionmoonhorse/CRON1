...
export declare class ActionRequirements extends APIResource {
     ...
     * ```
     */
    list(portingOrderID: string, query?: ActionRequirementListParams | null | undefined, options?: RequestOptions): PagePromise<PortingActionRequirementsDefaultFlatPagination, PortingActionRequirement>;
    /**
