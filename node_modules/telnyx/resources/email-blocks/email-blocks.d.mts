...
import * as ImportsAPI from "./imports.mjs";
import { EmailBlockImport, EmailBlockImportResponse, ImportCreateParams, Imports } from "./imports.mjs";
 ...
 */
export declare class EmailBlocks extends APIResource {
     ...
     * ```
     */
    list(query?: EmailBlockListParams | null | undefined, options?: RequestOptions): PagePromise<EmailBlocksDefaultFlatPagination, EmailBlock>;
    /**
     ...
     * ```
     */
    retrieveExport(query?: EmailBlockRetrieveExportParams | null | undefined, options?: RequestOptions): APIPromise<string>;
    /**
     ...
     * ```
     */
    retrieveEvents(id: string, query?: EmailBlockRetrieveEventsParams | null | undefined, options?: RequestOptions): PagePromise<EmailBlockRetrieveEventsResponsesDefaultFlatPagination, EmailBlockRetrieveEventsResponse>;
}
export type EmailBlocksDefaultFlatPagination = DefaultFlatPagination<EmailBlock>;
export type EmailBlockRetrieveEventsResponsesDefaultFlatPagination = DefaultFlatPagination<EmailBlockRetrieveEventsResponse>;
/**
