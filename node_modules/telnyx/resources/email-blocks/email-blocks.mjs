...
export class EmailBlocks extends APIResource {
    constructor() {
        super(...arguments);
        this.imports = new ImportsAPI.Imports(this._client);
    }
    /**
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/email_blocks', (DefaultFlatPagination), { query, ...options });
    }
    /**
    ...
    retrieveEvents(id, query = {}, options) {
        return this._client.getAPIList(path `/email_blocks/${id}/events`, (DefaultFlatPagination), { query, ...options });
    }
}
EmailBlocks.Imports = Imports;
//# sourceMappingURL=email-blocks.mjs.map