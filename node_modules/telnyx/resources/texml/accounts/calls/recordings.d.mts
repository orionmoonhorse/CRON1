...
export declare class Recordings extends APIResource {
     ...
     * ```
     */
    recordingSidJson(recordingSid: string, params: RecordingRecordingSidJsonParams, options?: RequestOptions): APIPromise<RecordingsJsonAPI.TexmlCreateCallRecordingResponseBody>;
}
