...
import { ParticipantDeleteParams, ParticipantParticipantsParams, ParticipantParticipantsResponse, ParticipantResource, ParticipantRetrieveParams, ParticipantRetrieveParticipantsParams, ParticipantRetrieveParticipantsResponse, ParticipantUpdateParams, Participants } from "./participants.mjs";
...
export declare class Conferences extends APIResource {
     ...
     * ```
     */
    retrieve(conferenceSid: string, params: ConferenceRetrieveParams, options?: RequestOptions): APIPromise<ConferenceResource>;
    /**
     ...
     * ```
     */
    update(conferenceSid: string, params: ConferenceUpdateParams, options?: RequestOptions): APIPromise<ConferenceResource>;
    /**
     ...
     * ```
     */
    retrieveRecordingsJson(conferenceSid: string, params: ConferenceRetrieveRecordingsJsonParams, options?: RequestOptions): APIPromise<RecordingsJsonAPI.TexmlGetCallRecordingsResponseBody>;
}
