...
export declare class Participants extends APIResource {
     ...
     * ```
     */
    retrieve(callSidOrParticipantLabel: string, params: ParticipantRetrieveParams, options?: RequestOptions): APIPromise<ParticipantResource>;
    /**
     ...
     * ```
     */
    update(callSidOrParticipantLabel: string, params: ParticipantUpdateParams, options?: RequestOptions): APIPromise<ParticipantResource>;
}
