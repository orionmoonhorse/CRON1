 ...
 */
class UacConnections extends resource_1.APIResource {
    constructor() {
        super(...arguments);
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/uac_connections', (pagination_1.DefaultFlatPagination), {
            query,
            ...options,
        });
    }
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/uac_connections/${id}`, options);
    }
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/uac_connections/${id}`, options);
    }
    /**
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/uac_connections/${id}`, { body, ...options });
    }
}
exports.UacConnections = UacConnections;
UacConnections.Actions = actions_1.Actions;
