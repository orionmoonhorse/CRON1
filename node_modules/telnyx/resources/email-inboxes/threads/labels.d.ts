...
export declare class Labels extends APIResource {
     ...
     * ```
     */
    deleteAll(threadID: string, params: LabelDeleteAllParams, options?: RequestOptions): APIPromise<LabelDeleteAllResponse>;
    /**
     ...
     * ```
     */
    create(threadID: string, params: LabelCreateParams, options?: RequestOptions): APIPromise<LabelCreateResponse>;
}
...
export declare namespace LabelDeleteAllResponse {
    interface Data {
        id: string;
        labels: Array<string>;
        record_type: 'email_thread';
...
export declare namespace Labels {
    export { type LabelCreateResponse as LabelCreateResponse, type LabelDeleteAllResponse as LabelDeleteAllResponse, type LabelDeleteAllParams as LabelDeleteAllParams, type LabelCreateParams as LabelCreateParams, };
}
