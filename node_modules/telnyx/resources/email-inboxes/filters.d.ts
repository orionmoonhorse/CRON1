...
export declare class Filters extends APIResource {
     ...
     * ```
     */
    deleteAll(inboxID: string, body: FilterDeleteAllParams, options?: RequestOptions): APIPromise<FilterDeleteAllResponse>;
    /**
     ...
     * ```
     */
    replace(inboxID: string, body: FilterReplaceParams, options?: RequestOptions): APIPromise<FilterReplaceResponse>;
}
