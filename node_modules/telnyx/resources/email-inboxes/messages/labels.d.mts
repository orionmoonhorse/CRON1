...
export declare class Labels extends APIResource {
     ...
     * ```
     */
    deleteAll(messageID: string, params: LabelDeleteAllParams, options?: RequestOptions): APIPromise<LabelDeleteAllResponse>;
    /**
     ...
     * ```
     */
    create(messageID: string, params: LabelCreateParams, options?: RequestOptions): APIPromise<LabelCreateResponse>;
}
/**
...
export declare namespace Labels {
    export { type LabelMutationRequest as LabelMutationRequest, type LabelCreateResponse as LabelCreateResponse, type LabelDeleteAllResponse as LabelDeleteAllResponse, type LabelDeleteAllParams as LabelDeleteAllParams, type LabelCreateParams as LabelCreateParams, };
}
//# sourceMappingURL=labels.d.mts.map