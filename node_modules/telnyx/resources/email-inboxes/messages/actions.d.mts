...
export declare class Actions extends APIResource {
     ...
     * ```
     */
    forward(messageID: string, params: ActionForwardParams, options?: RequestOptions): APIPromise<DraftsAPI.EmailMessageResponse>;
    /**
     ...
     * ```
     */
    reply(messageID: string, params: ActionReplyParams, options?: RequestOptions): APIPromise<DraftsAPI.EmailMessageResponse>;
    /**
     ...
     * ```
     */
    replyAll(messageID: string, params: ActionReplyAllParams, options?: RequestOptions): APIPromise<DraftsAPI.EmailMessageResponse>;
}
/**
...
export declare namespace InboxActionEmailAddressInput {
    interface InboxRecipientAddress {
        email: string;
        name?: string;
    }
}
 ...
 */
export type InboxActionRecipientInput = string | InboxActionRecipientInput.InboxRecipientAddress | Array<InboxActionEmailAddressInput>;
export declare namespace InboxActionRecipientInput {
    interface InboxRecipientAddress {
        email: string;
        name?: string;
    }
...
export declare namespace ActionForwardParams {
    interface InboxRecipientAddress {
        email: string;
        name?: string;
    }
