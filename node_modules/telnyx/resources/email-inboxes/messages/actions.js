...
class Actions extends resource_1.APIResource {
     ...
     * ```
     */
    forward(messageID, params, options) {
        const { inbox_id, ...body } = params;
        return this._client.post((0, path_1.path) `/email_inboxes/${inbox_id}/messages/${messageID}/actions/forward`, {
            body,
            ...options,
        });
    }
    ...
    reply(messageID, params, options) {
        const { inbox_id, ...body } = params;
        return this._client.post((0, path_1.path) `/email_inboxes/${inbox_id}/messages/${messageID}/actions/reply`, {
            body,
            ...options,
        });
    }
     ...
     * ```
     */
    replyAll(messageID, params, options) {
        const { inbox_id, ...body } = params;
        return this._client.post((0, path_1.path) `/email_inboxes/${inbox_id}/messages/${messageID}/actions/reply_all`, {
            body,
            ...options,
        });
    }
