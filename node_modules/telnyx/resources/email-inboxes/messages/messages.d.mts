...
import { InboundMessagesEmailBracketCursorPagination } from "../../webhooks.mjs";
import * as DraftsAPI from "../drafts.mjs";
import * as EmailMessagesAPI from "../../email-messages/email-messages.mjs";
import * as ActionsAPI from "./actions.mjs";
import { ActionForwardParams, ActionReplyAllParams, ActionReplyParams, Actions, InboxActionEmailAddressInput, InboxActionRecipientInput, ReplyEmailInboxMessageRequest } from "./actions.mjs";
import * as LabelsAPI from "./labels.mjs";
import { LabelCreateParams, LabelCreateResponse, LabelDeleteAllParams, LabelDeleteAllResponse, LabelMutationRequest, Labels } from "./labels.mjs";
import { APIPromise } from "../../../core/api-promise.mjs";
import { type EmailBracketCursorPaginationParams, PagePromise } from "../../../core/pagination.mjs";
...
export declare class Messages extends APIResource {
     ...
     * ```
     */
    list(inboxID: string, query?: MessageListParams | null | undefined, options?: RequestOptions): PagePromise<InboundMessagesEmailBracketCursorPagination, WebhooksAPI.InboundMessage>;
    /**
     ...
     * ```
     */
    drafts(messageID: string, params: MessageDraftsParams, options?: RequestOptions): APIPromise<DraftsAPI.EmailDraftResponse>;
}
...
export declare namespace Messages {
    export { type MessageUpdateResponse as MessageUpdateResponse, type MessageListParams as MessageListParams, type MessageUpdateParams as MessageUpdateParams, type MessageDraftsParams as MessageDraftsParams, };
    export { Actions as Actions, type InboxActionEmailAddressInput as InboxActionEmailAddressInput, type InboxActionRecipientInput as InboxActionRecipientInput, type ReplyEmailInboxMessageRequest as ReplyEmailInboxMessageRequest, type ActionForwardParams as ActionForwardParams, type ActionReplyParams as ActionReplyParams, type ActionReplyAllParams as ActionReplyAllParams, };
    export { Labels as Labels, type LabelMutationRequest as LabelMutationRequest, type LabelCreateResponse as LabelCreateResponse, type LabelDeleteAllResponse as LabelDeleteAllResponse, type LabelDeleteAllParams as LabelDeleteAllParams, type LabelCreateParams as LabelCreateParams, };
}
