...
import { EmailBracketCursorPagination, type EmailBracketCursorPaginationParams, EmailCursorPagination, PagePromise } from "../../core/pagination.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
/**
 * Create, list, retrieve, update, delete, and send unsent draft messages belonging to an agent inbox.
 */
export declare class Drafts extends APIResource {
    /**
     ...
     * ```
     */
    list(inboxID: string, query?: DraftListParams | null | undefined, options?: RequestOptions): PagePromise<EmailDraftsEmailBracketCursorPagination, EmailDraft>;
    /**
     ...
     * ```
     */
    create(inboxID: string, body?: DraftCreateParams | null | undefined, options?: RequestOptions): APIPromise<EmailDraftResponse>;
    /**
     ...
     * ```
     */
    retrieve(draftID: string, params: DraftRetrieveParams, options?: RequestOptions): APIPromise<EmailDraftResponse>;
    /**
     ...
     * ```
     */
    update(draftID: string, params: DraftUpdateParams, options?: RequestOptions): APIPromise<EmailDraftResponse>;
    /**
...
export interface EmailMessage {
     ...
     */
    status: 'queued' | 'scheduled' | 'cancelled' | 'sandbox' | 'sending' | 'sent' | 'failed' | 'deferred' | 'delivered' | 'bounced' | 'complained' | 'rejected' | 'opened' | 'clicked' | 'unsubscribed';
    subject: string;
