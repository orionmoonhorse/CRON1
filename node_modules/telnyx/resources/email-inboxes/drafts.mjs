...
export class Drafts extends APIResource {
     ...
     * ```
     */
    list(inboxID, query = {}, options) {
        return this._client.getAPIList(path `/email_inboxes/${inboxID}/drafts`, (EmailBracketCursorPagination), { query, ...options });
    }
    /**
     ...
     * ```
     */
    retrieve(draftID, params, options) {
        const { inbox_id } = params;
