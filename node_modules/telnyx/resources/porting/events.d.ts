...
export declare class Events extends APIResource {
     ...
     * ```
     */
    list(query?: EventListParams | null | undefined, options?: RequestOptions): PagePromise<PortingEventsDefaultFlatPagination, PortingEvent>;
    /**
...
export type PortingEvent = PortingEventDeletedPayload | PortingEventMessagingChangedPayload | PortingEventStatusChangedEvent | PortingEventNewCommentEvent | PortingEventSplitEvent | PortingEventWithoutWebhook;
...
export declare namespace Events {
    export { type PortingEvent as PortingEvent, type PortingEventDeletedPayload as PortingEventDeletedPayload, type PortingEventMessagingChangedPayload as PortingEventMessagingChangedPayload, type PortingEventNewCommentEvent as PortingEventNewCommentEvent, type PortingEventSplitEvent as PortingEventSplitEvent, type PortingEventStatusChangedEvent as PortingEventStatusChangedEvent, type PortingEventWithoutWebhook as PortingEventWithoutWebhook, type EventRetrieveResponse as EventRetrieveResponse, type PortingEventsDefaultFlatPagination as PortingEventsDefaultFlatPagination, type EventListParams as EventListParams, };
}
