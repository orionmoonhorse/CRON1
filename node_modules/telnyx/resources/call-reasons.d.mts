 ...
 */
export declare class CallReasons extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: CallReasonListParams | null | undefined, options?: RequestOptions): PagePromise<CallReasonListResponsesDefaultFlatPagination, CallReasonListResponse>;
    /**
     ...
     * ```
     */
    validate(params: CallReasonValidateParams, options?: RequestOptions): APIPromise<CallReasonValidateResponse>;
}
...
export declare namespace CallReasonValidateResponse {
    interface Data {
        /**
