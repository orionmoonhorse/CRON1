...
export declare class Recipients extends APIResource {
     ...
     * ```
     */
    list(emailID: string, query?: RecipientListParams | null | undefined, options?: RequestOptions): PagePromise<EmailRecipientsEmailCursorPagination, EmailRecipient>;
    /**
     ...
     * ```
     */
    retrieve(recipientID: string, params: RecipientRetrieveParams, options?: RequestOptions): APIPromise<RecipientRetrieveResponse>;
}
...
export declare namespace Recipients {
    export { type EmailRecipient as EmailRecipient, type RecipientRetrieveResponse as RecipientRetrieveResponse, type EmailRecipientsEmailCursorPagination as EmailRecipientsEmailCursorPagination, type RecipientListParams as RecipientListParams, type RecipientRetrieveParams as RecipientRetrieveParams, };
}
