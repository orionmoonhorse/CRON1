...
import * as EmailMessagesAPI from "./email-messages.mjs";
import * as EmailEventsAPI from "../email-events.mjs";
import * as DraftsAPI from "../email-inboxes/drafts.mjs";
import { EmailMessagesEmailCursorPagination } from "../email-inboxes/drafts.mjs";
import * as RecipientsAPI from "./recipients.mjs";
import { EmailRecipient, EmailRecipientsEmailCursorPagination, RecipientListParams, RecipientRetrieveParams, RecipientRetrieveResponse, Recipients } from "./recipients.mjs";
 ...
 */
export declare class EmailMessages extends APIResource {
     ...
     * ```
     */
    list(query?: EmailMessageListParams | null | undefined, options?: RequestOptions): PagePromise<EmailMessagesEmailCursorPagination, DraftsAPI.EmailMessage>;
    /**
     ...
     * ```
     */
    create(params: EmailMessageCreateParams, options?: RequestOptions): APIPromise<DraftsAPI.EmailMessageResponse>;
    /**
     ...
     * ```
     */
    retrieveEvents(emailID: string, query?: EmailMessageRetrieveEventsParams | null | undefined, options?: RequestOptions): PagePromise<MessageEventsEmailCursorPagination, MessageEvent>;
    /**
...
export declare namespace EmailMessageRetrieveResponse {
    interface Data extends DraftsAPI.EmailMessage {
        /**
...
export declare namespace EmailMessageBatchResponse {
    interface Error {
        /**
         * Batch item errors use `message` (not `detail`) for the human-readable text.
         */
        code: 'bad_request' | 'not_found' | 'forbidden' | 'service_unavailable' | 'validation_error' | 'recipient_suppressed' | 'reputation_suspended';
        /**
...
export declare namespace EmailMessageBatchParams {
    /**
