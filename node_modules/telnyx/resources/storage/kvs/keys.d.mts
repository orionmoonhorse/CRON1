...
import { CursorFlatPagination, type CursorFlatPaginationParams, PagePromise } from "../../../core/pagination.mjs";
...
export declare class Keys extends APIResource {
     ...
     * ```
     */
    list(id: string, query?: KeyListParams | null | undefined, options?: RequestOptions): PagePromise<KeyListResponsesCursorFlatPagination, KeyListResponse>;
    /**
     ...
     * ```
     */
    update(key: string, body: string | ArrayBuffer | ArrayBufferView | Blob | DataView, params: KeyUpdateParams, options?: RequestOptions): APIPromise<void>;
}
...
export declare namespace Keys {
    export { type KeyListResponse as KeyListResponse, type KeyListResponsesCursorFlatPagination as KeyListResponsesCursorFlatPagination, type KeyListParams as KeyListParams, type KeyDeleteParams as KeyDeleteParams, type KeyRetrieveParams as KeyRetrieveParams, type KeyUpdateParams as KeyUpdateParams, };
}
