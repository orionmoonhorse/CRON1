...
class Keys extends resource_1.APIResource {
    ...
    list(id, query = {}, options) {
        return this._client.getAPIList((0, path_1.path) `/storage/kvs/${id}/keys`, (pagination_1.CursorFlatPagination), {
            query,
            ...options,
        });
    }
    ...
    delete(key, params, options) {
        const { id } = params;
        return this._client.delete((0, path_1.path) `/storage/kvs/${id}/keys/${key}`, {
            ...options,
    ...
    retrieve(key, params, options) {
        const { id } = params;
        return this._client.get((0, path_1.path) `/storage/kvs/${id}/keys/${key}`, {
            ...options,
     ...
     * ```
     */
    update(key, body, params, options) {
        const { id, ttl_secs } = params;
        return this._client.put((0, path_1.path) `/storage/kvs/${id}/keys/${key}`, {
            body: body,
            query: { ttl_secs },
            ...options,
