...
import { KeyDeleteParams, KeyListParams, KeyListResponse, KeyListResponsesCursorFlatPagination, KeyRetrieveParams, KeyUpdateParams, Keys } from "./keys.mjs";
 ...
 */
export declare class Kvs extends APIResource {
    keys: KeysAPI.Keys;
    /**
     ...
     * ```
     */
    list(query?: KvListParams | null | undefined, options?: RequestOptions): PagePromise<KvNamespacesDefaultFlatPagination, KvNamespace>;
    /**
...
export declare namespace Kvs {
    export { type EdgeComputePaginationMeta as EdgeComputePaginationMeta, type KvNamespace as KvNamespace, type KvNamespaceResponseWrapper as KvNamespaceResponseWrapper, type KvNamespacesDefaultFlatPagination as KvNamespacesDefaultFlatPagination, type KvListParams as KvListParams, type KvCreateParams as KvCreateParams, };
    export { Keys as Keys, type KeyListResponse as KeyListResponse, type KeyListResponsesCursorFlatPagination as KeyListResponsesCursorFlatPagination, type KeyListParams as KeyListParams, type KeyDeleteParams as KeyDeleteParams, type KeyRetrieveParams as KeyRetrieveParams, type KeyUpdateParams as KeyUpdateParams, };
}
//# sourceMappingURL=kvs.d.mts.map