...
import { ActionQueryParams, ActionQueryResponse, Actions } from "./actions.js";
 ...
 */
export declare class Sqldbs extends APIResource {
     ...
     * ```
     */
    list(query?: SqldbListParams | null | undefined, options?: RequestOptions): PagePromise<SqlDatabasesDefaultFlatPagination, SqlDatabase>;
    /**
     ...
     * ```
     */
    delete(id: string, params?: SqldbDeleteParams | null | undefined, options?: RequestOptions): APIPromise<void>;
    /**
...
export declare namespace Sqldbs {
    export { type SqlDatabase as SqlDatabase, type SqlDatabaseResponseWrapper as SqlDatabaseResponseWrapper, type SqlDatabasesDefaultFlatPagination as SqlDatabasesDefaultFlatPagination, type SqldbListParams as SqldbListParams, type SqldbCreateParams as SqldbCreateParams, type SqldbDeleteParams as SqldbDeleteParams, };
    export { Actions as Actions, type ActionQueryResponse as ActionQueryResponse, type ActionQueryParams as ActionQueryParams, };
}
//# sourceMappingURL=sqldbs.d.ts.map