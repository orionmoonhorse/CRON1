...
export declare namespace PayPromptValue {
    /**
     * A text-to-speech prompt with optional matching qualifiers.
     */
    interface PayPromptList {
        /**
...
export interface TranscriptionConfig {
     ...
     */
    model?: 'deepgram/flux' | 'flux' | 'deepgram/nova-3' | 'deepgram/nova-2' | 'speechmatics/standard' | 'speechmatics/enhanced' | 'assemblyai/universal-streaming' | 'xai/grok-stt' | 'soniox/stt-rt-v4' | 'nvidia/parakeet-v3' | 'humain/realtime' | 'reson8/turns' | 'cohere/ar-stt' | 'azure/fast' | 'azure/realtime' | 'google/latest_long' | 'distil-whisper/distil-large-v2' | 'openai/whisper-large-v3-turbo';
}
...
export interface ActionGatherUsingAIParams {
     ...
     */
    voice_settings?: ElevenLabsVoiceSettings | TelnyxVoiceSettings | AwsVoiceSettings | Shared.AzureVoiceSettings | Shared.ResembleVoiceSettings | Shared.XaiVoiceSettings;
}
...
export interface ActionGatherUsingSpeakParams {
     ...
     * The settings associated with the voice selected
     */
    voice_settings?: ElevenLabsVoiceSettings | TelnyxVoiceSettings | AwsVoiceSettings | Shared.MinimaxVoiceSettings | Shared.AzureVoiceSettings | Shared.ResembleVoiceSettings | Shared.InworldVoiceSettings | Shared.XaiVoiceSettings;
}
...
export interface ActionStartNoiseSuppressionParams {
     ...
     */
    noise_suppression_engine?: 'Denoiser' | 'DeepFilterNet' | 'Krisp' | 'AiCoustics' | 'aic_l_quail' | 'aic_l_rook' | 'aic_s_quail' | 'aic_s_rook' | 'quail_voice_focus_s' | 'quail_voice_focus_xs';
    /**
...
export interface ActionPayParams {
     ...
     * `payment_token`.
     */
    valid_card_types?: Array<'visa' | 'mastercard' | 'amex' | 'maestro' | 'discover' | 'optima' | 'jcb' | 'diners-club' | 'enroute'>;
    /**
...
export declare namespace ActionPayParams {
    /**
     * Custom text-to-speech prompts keyed by payment collection step.
     */
    interface Prompts {
