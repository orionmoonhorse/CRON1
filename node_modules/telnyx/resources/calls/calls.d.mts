...
export interface ConversationRelayEmbeddedConfig {
     ...
     */
    voice_settings?: ActionsAPI.ElevenLabsVoiceSettings | ActionsAPI.TelnyxVoiceSettings | ActionsAPI.AwsVoiceSettings | Shared.MinimaxVoiceSettings | Shared.AzureVoiceSettings | Shared.ResembleVoiceSettings | Shared.InworldVoiceSettings | Shared.XaiVoiceSettings;
}
/**
 * Settings for handling caller interruptions during Conversation Relay speech.
 */
...
export declare namespace Calls {
    export { type CallAssistantRequest as CallAssistantRequest, type ConversationRelayEmbeddedConfig as ConversationRelayEmbeddedConfig, type ConversationRelayInterruptionSettings as ConversationRelayInterruptionSettings, type ConversationRelayLanguage as ConversationRelayLanguage, type CustomSipHeader as CustomSipHeader, type DialogflowConfig as DialogflowConfig, type SipHeader as SipHeader, type SoundModifications as SoundModifications, type StreamBidirectionalCodec as StreamBidirectionalCodec, type StreamBidirectionalMode as StreamBidirectionalMode, type StreamBidirectionalSamplingRate as StreamBidirectionalSamplingRate, type StreamBidirectionalTargetLegs as StreamBidirectionalTargetLegs, type StreamCodec as StreamCodec, type CallDialResponse as CallDialResponse, type CallRetrieveStatusResponse as CallRetrieveStatusResponse, type CallDialParams as CallDialParams, };
    export { Actions as Actions, type AIAssistantJoinParticipant as AIAssistantJoinParticipant, type AssistantMessage as AssistantMessage, type AwsVoiceSettings as AwsVoiceSettings, type CallControlCommandResult as CallControlCommandResult, type CallControlCommandResultWithConversationID as CallControlCommandResultWithConversationID, type ConversationRelayInterruptible as ConversationRelayInterruptible, type DeepgramNova2Config as DeepgramNova2Config, type DeepgramNova3Config as DeepgramNova3Config, type DeveloperMessage as DeveloperMessage, type ElevenLabsVoiceSettings as ElevenLabsVoiceSettings, type GoogleTranscriptionLanguage as GoogleTranscriptionLanguage, type InterruptionSettings as InterruptionSettings, type Loopcount as Loopcount, type PayPromptValue as PayPromptValue, type StopRecordingRequest as StopRecordingRequest, type SystemMessage as SystemMessage, type TelnyxTranscriptionLanguage as TelnyxTranscriptionLanguage, type TelnyxVoiceSettings as TelnyxVoiceSettings, type ToolMessage as ToolMessage, type TranscriptionConfig as TranscriptionConfig, type TranscriptionEngineAConfig as TranscriptionEngineAConfig, type TranscriptionEngineAssemblyaiConfig as TranscriptionEngineAssemblyaiConfig, type TranscriptionEngineAzureConfig as TranscriptionEngineAzureConfig, type TranscriptionEngineBConfig as TranscriptionEngineBConfig, type TranscriptionEngineCohereConfig as TranscriptionEngineCohereConfig, type TranscriptionEngineDeepgramConfig as TranscriptionEngineDeepgramConfig, type TranscriptionEngineGoogleConfig as TranscriptionEngineGoogleConfig, type TranscriptionEngineHumainConfig as TranscriptionEngineHumainConfig, type TranscriptionEngineParakeetConfig as TranscriptionEngineParakeetConfig, type TranscriptionEngineReson8Config as TranscriptionEngineReson8Config, type TranscriptionEngineSonioxConfig as TranscriptionEngineSonioxConfig, type TranscriptionEngineSpeechmaticsConfig as TranscriptionEngineSpeechmaticsConfig, type TranscriptionEngineTelnyxConfig as TranscriptionEngineTelnyxConfig, type TranscriptionEngineXaiConfig as TranscriptionEngineXaiConfig, type TranscriptionStartRequest as TranscriptionStartRequest, type UserMessage as UserMessage, type ActionAddAIAssistantMessagesResponse as ActionAddAIAssistantMessagesResponse, type ActionAnswerResponse as ActionAnswerResponse, type ActionBridgeResponse as ActionBridgeResponse, type ActionEnqueueResponse as ActionEnqueueResponse, type ActionGatherResponse as ActionGatherResponse, type ActionGatherUsingAIResponse as ActionGatherUsingAIResponse, type ActionGatherUsingAudioResponse as ActionGatherUsingAudioResponse, type ActionGatherUsingSpeakResponse as ActionGatherUsingSpeakResponse, type ActionHangupResponse as ActionHangupResponse, type ActionJoinAIAssistantResponse as ActionJoinAIAssistantResponse, type ActionLeaveQueueResponse as ActionLeaveQueueResponse, type ActionPauseRecordingResponse as ActionPauseRecordingResponse, type ActionPayResponse as ActionPayResponse, type ActionReferResponse as ActionReferResponse, type ActionRejectResponse as ActionRejectResponse, type ActionResumeRecordingResponse as ActionResumeRecordingResponse, type ActionSendDtmfResponse as ActionSendDtmfResponse, type ActionSendSipInfoResponse as ActionSendSipInfoResponse, type ActionSpeakResponse as ActionSpeakResponse, type ActionStartAIAssistantResponse as ActionStartAIAssistantResponse, type ActionStartConversationRelayResponse as ActionStartConversationRelayResponse, type ActionStartForkingResponse as ActionStartForkingResponse, type ActionStartNoiseSuppressionResponse as ActionStartNoiseSuppressionResponse, type ActionStartPlaybackResponse as ActionStartPlaybackResponse, type ActionStartRecordingResponse as ActionStartRecordingResponse, type ActionStartSiprecResponse as ActionStartSiprecResponse, type ActionStartStreamingResponse as ActionStartStreamingResponse, type ActionStartTranscriptionResponse as ActionStartTranscriptionResponse, type ActionStopAIAssistantResponse as ActionStopAIAssistantResponse, type ActionStopConversationRelayResponse as ActionStopConversationRelayResponse, type ActionStopForkingResponse as ActionStopForkingResponse, type ActionStopGatherResponse as ActionStopGatherResponse, type ActionStopNoiseSuppressionResponse as ActionStopNoiseSuppressionResponse, type ActionStopPlaybackResponse as ActionStopPlaybackResponse, type ActionStopRecordingResponse as ActionStopRecordingResponse, type ActionStopSiprecResponse as ActionStopSiprecResponse, type ActionStopStreamingResponse as ActionStopStreamingResponse, type ActionStopTranscriptionResponse as ActionStopTranscriptionResponse, type ActionSwitchSupervisorRoleResponse as ActionSwitchSupervisorRoleResponse, type ActionTransferResponse as ActionTransferResponse, type ActionUpdateClientStateResponse as ActionUpdateClientStateResponse, type ActionStartAIAssistantParams as ActionStartAIAssistantParams, type ActionStopAIAssistantParams as ActionStopAIAssistantParams, type ActionAnswerParams as ActionAnswerParams, type ActionBridgeParams as ActionBridgeParams, type ActionUpdateClientStateParams as ActionUpdateClientStateParams, type ActionEnqueueParams as ActionEnqueueParams, type ActionStartForkingParams as ActionStartForkingParams, type ActionStopForkingParams as ActionStopForkingParams, type ActionGatherParams as ActionGatherParams, type ActionStopGatherParams as ActionStopGatherParams, type ActionGatherUsingAIParams as ActionGatherUsingAIParams, type ActionGatherUsingAudioParams as ActionGatherUsingAudioParams, type ActionGatherUsingSpeakParams as ActionGatherUsingSpeakParams, type ActionHangupParams as ActionHangupParams, type ActionLeaveQueueParams as ActionLeaveQueueParams, type ActionStartPlaybackParams as ActionStartPlaybackParams, type ActionStopPlaybackParams as ActionStopPlaybackParams, type ActionPauseRecordingParams as ActionPauseRecordingParams, type ActionResumeRecordingParams as ActionResumeRecordingParams, type ActionStartRecordingParams as ActionStartRecordingParams, type ActionStopRecordingParams as ActionStopRecordingParams, type ActionReferParams as ActionReferParams, type ActionRejectParams as ActionRejectParams, type ActionSendDtmfParams as ActionSendDtmfParams, type ActionSendSipInfoParams as ActionSendSipInfoParams, type ActionStartSiprecParams as ActionStartSiprecParams, type ActionStopSiprecParams as ActionStopSiprecParams, type ActionSpeakParams as ActionSpeakParams, type ActionStartStreamingParams as ActionStartStreamingParams, type ActionStopStreamingParams as ActionStopStreamingParams, type ActionStartNoiseSuppressionParams as ActionStartNoiseSuppressionParams, type ActionStopNoiseSuppressionParams as ActionStopNoiseSuppressionParams, type ActionSwitchSupervisorRoleParams as ActionSwitchSupervisorRoleParams, type ActionStartTranscriptionParams as ActionStartTranscriptionParams, type ActionStopTranscriptionParams as ActionStopTranscriptionParams, type ActionTransferParams as ActionTransferParams, type ActionAddAIAssistantMessagesParams as ActionAddAIAssistantMessagesParams, type ActionJoinAIAssistantParams as ActionJoinAIAssistantParams, type ActionStartConversationRelayParams as ActionStartConversationRelayParams, type ActionStopConversationRelayParams as ActionStopConversationRelayParams, type ActionPayParams as ActionPayParams, };
}
