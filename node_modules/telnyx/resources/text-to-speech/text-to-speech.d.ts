...
export declare class TextToSpeech extends APIResource {
     ...
     * ```
     */
    generateSpeech(body: TextToSpeechGenerateSpeechParams, options?: RequestOptions): APIPromise<TextToSpeechGenerateSpeechResponse>;
    /**
     ...
     * ```
     */
    retrieveSpeech(query?: TextToSpeechRetrieveSpeechParams | null | undefined, options?: RequestOptions): APIPromise<void>;
}
/**
...
export interface TextToSpeechGenerateSpeechParams {
     ...
     */
    aws?: TextToSpeechGenerateSpeechParams.Aws;
    /**
     * Azure Cognitive Services provider-specific parameters.
     */
    azure?: TextToSpeechGenerateSpeechParams.Azure;
    /**
     ...
     */
    minimax?: TextToSpeechGenerateSpeechParams.Minimax;
    /**
     ...
     */
    xai?: TextToSpeechGenerateSpeechParams.Xai;
}
export declare namespace TextToSpeechGenerateSpeechParams {
    /**
     * AWS Polly provider-specific parameters.
     */
    interface Aws {
