...
export declare class VoiceSDKCallReports extends APIResource {
     ...
     * request parameters.
     */
    list(query?: VoiceSDKCallReportListParams | null | undefined, options?: RequestOptions): PagePromise<VoiceSDKCallReportsDefaultFlatPagination, VoiceSDKCallReport>;
    /**
...
export interface VoiceSDKCallReport {
    ...
    stats?: Array<{
        [key: string]: unknown;
    }> | VoiceSDKCallReport.VoiceSDKCallReportStatsObject;
    /**
...
export declare namespace VoiceSDKCallReport {
    /**
     ...
     */
    interface VoiceSDKCallReportStatsObject {
        /**
