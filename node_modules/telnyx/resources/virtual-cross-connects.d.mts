...
export declare namespace RegionOut {
    interface Region {
        /**
...
export interface VirtualCrossConnectCreate extends GlobalIPAssignmentsAPI.Record, PublicInternetGatewaysAPI.NetworkInterface {
    /**
