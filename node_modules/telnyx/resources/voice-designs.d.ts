...
export declare class VoiceDesigns extends APIResource {
     ...
     * ```
     */
    list(query?: VoiceDesignListParams | null | undefined, options?: RequestOptions): PagePromise<VoiceDesignSummaryDataDefaultFlatPagination, VoiceDesignSummaryData>;
    /**
     ...
     * ```
     */
    retrieve(id: string, query?: VoiceDesignRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<VoiceDesignResponse>;
    /**
