...
import * as ThreadsAPI from "./email-inboxes/threads/threads.mjs";
import { EmailBracketCursorPagination } from "../core/pagination.mjs";
...
export declare namespace ArtifactCompletedWebhookEvent {
    /**
     * Completed artifact, including its generated content.
     */
    interface Data {
...
export declare namespace ArtifactFailedWebhookEvent {
    /**
     * Failed artifact reference and reason.
     */
    interface Data {
...
export declare namespace CallPaymentCompletedWebhookEvent {
    interface Data {
        /**
         * Unique identifier for the event.
         */
    ...
    namespace Data {
        interface Payload {
             ...
             */
            payment_card_type?: 'visa' | 'mastercard' | 'amex' | 'optima' | 'discover' | 'diners-club' | 'jcb' | 'maestro' | 'enroute';
            /**
             ...
             */
            result?: 'success' | 'payment-connector-error' | 'internal-error' | 'too-many-failed-attempts' | 'cancelled';
            /**
...
export declare namespace CallPaymentProgressWebhookEvent {
    interface Data {
        /**
         * Unique identifier for the event.
         */
    ...
    namespace Data {
        interface Payload {
             ...
             */
            payment_step?: 'payment-card-number' | 'expiration-date' | 'postal-code' | 'security-code' | 'bank-routing-number' | 'bank-account-number' | 'payment-processing';
            /**
             * Fully masked card security code.
             */
            security_code?: string;
...
export declare namespace RecordingAvailableWebhookEvent {
    /**
     * Available recording types.
     */
    interface Data {
...
export declare namespace SessionStatusChangedWebhookEvent {
    /**
     * Status transition details.
     */
    interface Data {
...
export declare namespace TranscriptCompletedWebhookEvent {
    /**
     * Finalized transcript details.
     */
    interface Data {
