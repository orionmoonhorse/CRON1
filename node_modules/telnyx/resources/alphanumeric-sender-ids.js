...
exports.AlphanumericSenderIDs = void 0;
const resource_1 = require("../core/resource.js");
const pagination_1 = require("../core/pagination.js");
const path_1 = require("../internal/utils/path.js");
class AlphanumericSenderIDs extends resource_1.APIResource {
    /**
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/alphanumeric_sender_ids', (pagination_1.DefaultFlatPagination), {
            query,
            ...options,
        });
    }
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/alphanumeric_sender_ids/${id}`, options);
    }
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/alphanumeric_sender_ids/${id}`, options);
    }
}
exports.AlphanumericSenderIDs = AlphanumericSenderIDs;
//# sourceMappingURL=alphanumeric-sender-ids.js.map