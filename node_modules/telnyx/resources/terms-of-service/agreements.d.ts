 ...
 */
export declare class Agreements extends APIResource {
    /**
     ...
     */
    list(query?: AgreementListParams | null | undefined, options?: RequestOptions): PagePromise<TosAgreementsDefaultFlatPagination, TosAgreement>;
    /**
...
export declare namespace Agreements {
    export { type TosAgreement as TosAgreement, type TosAgreementWrapped as TosAgreementWrapped, type TosProductType as TosProductType, type TosAgreementsDefaultFlatPagination as TosAgreementsDefaultFlatPagination, type AgreementListParams as AgreementListParams, };
}
