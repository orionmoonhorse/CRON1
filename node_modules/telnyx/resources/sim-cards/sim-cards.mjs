...
export class SimCards extends APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/sim_cards', (DefaultFlatPagination), {
            query,
            ...options,
        });
    }
    ...
    listWirelessConnectivityLogs(id, query = {}, options) {
        return this._client.getAPIList(path `/sim_cards/${id}/wireless_connectivity_logs`, (DefaultFlatPagination), { query, ...options });
    }
}
