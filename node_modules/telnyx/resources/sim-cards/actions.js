...
class Actions extends resource_1.APIResource {
     ...
     * ```
     */
    disableVoice(id, options) {
        return this._client.post((0, path_1.path) `/sim_cards/${id}/actions/disable_voice`, options);
    }
    /**
     ...
     * ```
     */
    enableVoice(id, body = {}, options) {
        return this._client.post((0, path_1.path) `/sim_cards/${id}/actions/enable_voice`, { body, ...options });
    }
}
